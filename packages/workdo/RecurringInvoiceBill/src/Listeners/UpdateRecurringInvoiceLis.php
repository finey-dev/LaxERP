...
class UpdateRecurringInvoiceLis
{
    /**
    ...
    public function handle(UpdateInvoice $event)
    {
        ...
        $invoice = $event->invoice;
            ...
            $RecurringInvoiceBill                   = RecurringInvoiceBill::where('invoice_id',$invoice->id)->where('workspace',getActiveWorkSpace())->where('created_by',creatorId())->where('recurring_type','invoice')->first();
