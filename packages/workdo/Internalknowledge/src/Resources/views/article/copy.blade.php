{{ Form::model($article, ['route' => ['article.copy.store', $article->id], 'method' => 'POST']) }}
<div class="modal-body">
    <div class="row">
        <div class="form-group col-md-12">
            {{ Form::label('book', __('Book'), ['class' => 'form-label']) }}
            <select class="form-control select" required="required" id="book" name="book">
        ...
        <div class="form-group col-md-12" id="editor-container">
            ...
            <textarea class="summernote" id="editor" rows="2" name="content">{{ $article->content }}</textarea>
        </div>
        ...
        <div class="form-group col-md-12">
            <div class="tab-pane fade show" id="tab-2" role="tabpanel">
                @include('customfield::formBuilder', ['fildedata' => $article->customField])
            </div>
        </div>
    @endif
    </div>
...
<div class="modal-footer">
    ...
    <input type="submit" value="{{ __('Copy') }}" class="btn  btn-primary">
</div>
