<div class="action-btn me-2">
    <a href="#" class="btn btn-sm  align-items-center cp_link  bg-primary"
        ...
        data-bs-toggle="tooltip" title="{{ __('Copy') }}" data-original-title="{{ __('Click to copy article link') }}">
...
<div class="action-btn me-2">
    <a class="mx-3 btn btn-sm align-items-center bg-warning" data-bs-toggle="tooltip"
...
@permission('article delete')
    <div class="action-btn">
        {{ Form::open(['route' => ['article.destroy', $article->id], 'class' => 'm-0', 'enctype' => 'multipart/form-data']) }}
        @method('DELETE')
