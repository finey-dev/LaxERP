...
@php
    $path = url('packages/workdo/Internalknowledge/src/marketplace');
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
                ...
                <div class="row row-gap align-items-center pdp-summery-row">
                    <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                        <div class="pdp-summery">
                            ...
                            <p>{{ __('An internal knowledge base is a company-made resource consisting of process documents and tools that members of the organization need to do their jobs properly. Its purpose is to mitigate organizational, technical, and learning difficulties often faced within companies that limit productivity.') }}
                            </p>
                            <div class="price">
                                <ins><span
        ...
        <section class="dedicated-themes-section padding-bottom">
            <div class="container">
                <div class="section-title text-center">
                    <h2>{{ __('Internal ') }}<b>{{ __('Knowledge (KB) ') }}</b>{{ __('Management') }}</h2>
                    <p>{{ __('The internal knowledge management system captures organizational knowledge that is known to long-term employees, making it accessible to the wider team and helping in maintaining organizational continuity.') }}
                    </p>
                </div>
                    ...
                    <div class="col-lg-5 col-md-6 col-12">
                        <div class="abt-theme">
                            <div class="section-title">
                                ...
                                <h2>{{ __('What are the benefits of Internal Knowledge (KB) ?') }}</h2>
                            </div>
                            <p>{{ __('Digital knowledge modules can reduce the costs associated with printing and distribution of physical books or articles.
                                                        Overall, an internal knowledge module within a book or article enhances the readers experience by providing a well-organized, interactive, and easily accessible source of information and learning. It also benefits authors and publishers by offering new ways to engage readers and improve the quality and relevance of their content.') }}
                            </p>
                        </div>
                    </div>
