                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-icon-user">
                                            {{ Form::number('purchase_price', !empty($productService->sale_price)?$productService->sale_price:'', ['class' => 'form-control', 'step' => '0.01','required' => 'required', 'placeholder' => __('Enter Purchase Price')]) }}
                                        </div>
                                    </div>
                                </div>
