...
@section('page-action')
    <div>
        <a href="{{ route('holidays.index') }}" class="btn btn-sm btn-primary" data-bs-toggle="tooltip"
        ...
        @permission('workload holidays create')
            <a  class="btn btn-sm btn-primary" data-ajax-popup="true" data-size="md"
                data-title="{{ __('Create New Holiday') }}" data-url="{{ route('holidays.create') }}" data-bs-toggle="tooltip"
...
@endsection
@push('css')
    <link rel="stylesheet" href="{{ asset('packages/workdo/TeamWorkload/src/Resources/assets/css/main.css') }}">
@endpush
@section('content')
    <div class="row">
        <div class="col-sm-12 col-lg-12 col-xl-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    {{ Form::open(['route' => ['holidays.calender'], 'method' => 'get', 'id' => 'holiday_filter']) }}
                    <div class="d-flex align-items-center justify-content-end">
                        ...
                        <div class="col-auto float-end ms-2 mt-4">
                            ...
                            <a href="{{ route('holidays.calender') }}" class="btn btn-sm btn-danger"
...
@endsection
@push('scripts')
    <script src="{{ asset('packages/workdo/TeamWorkload/src/Resources/assets/js/main.min.js') }}"></script>
