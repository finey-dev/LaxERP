            ...
            <div class="row row-gap align-items-center pdp-summery-row">
                <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                    <div class="pdp-summery">
                        ...
                        <p>{{ __('Team Workload Module is a process of distributing work among employees and monitoring people’s utilization over time. The goal is to make sure the work is delivered within the planned time frame, but also to keep a healthy balance in terms of the amount of work every team member needs to do.') }}
                        </p>
                        <div class="price">
                            <ins><span
                ...
                <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                    <div class="pdp-image-wrapper">
                        <div class="pdp-media banner-img-wrapper">
                            ...
                            <img src="{{ asset($old_path . '/image1.png') }}" alt="" class="inner-frame-img">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="section-title text-center">
                <h2>{{ __('Team') }}<b>{{ __('Workload') }}</b></h2>
                <p>{{ __(' With the Team Workload module, we can find out the total number of hours an employee has the ability to work in a week and the total number of hours worked in these occupations.') }}
                </p>
            </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{ __('Setup for Working') }}</h2>
                        </div>
                        <p>{{__('Implement a system to accurately track and record overtime hours. This can be done through the same timesheet system, but overtime hours must be clearly distinguished from regular work hours. Apart from this we can also set the working hours of the day for a particular user and holidays for the user. when you set holiday for user at that you can see your users estiamted time and Spent time show diffrent.The main advantage of this module is that you can ensure a balanced workload and better productivity.')}}</p>
                    </div>
                </div>
                <div class="col-lg-7 col-md-6 col-12">
                    <div class="dash-theme-preview">
                        <img src="{{ asset($old_path . '/image2.png') }}" alt="">
                    </div>
                </div>
            </div>
            <div class="row row-gap align-items-center ">
                <div class="col-lg-7 col-md-6 col-12">
                    <div class="dash-theme-preview">
                        <img src="{{ asset($old_path . '/image3.png') }}" alt="">
                    </div>
                </div>
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{ __('Reporting and Analytics') }}</h2>
                        </div>
                        <p>{{ __('Team Workload report provides total capacity ,total estimated time and total avaliable capacity and also you can show particular users Total Capcity Hours in using this report.') }}
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="screenshot-slider">
                <div class="screenshot-itm">
                    <div class="screenshot-image">
                        <a href="{{asset($old_path.'/image1.png')}}" target="_blank" class="img-zoom">
                            <img src="{{asset($old_path.'/image1.png')}}" alt="">
                        </a>
                    </div>
                ...
                <div class="screenshot-itm">
                    <div class="screenshot-image">
                        <a href="{{asset($old_path.'/image2.png')}}" target="_blank" class="img-zoom">
                            <img src="{{asset($old_path.'/image2.png')}}" alt="">
                        </a>
                    </div>
                    <div class="scr-labl"></div>
                ...
                <div class="screenshot-itm">
                    <div class="screenshot-image">
                        <a href="{{asset($old_path.'/image3.png')}}" target="_blank" class="img-zoom">
                            <img src="{{asset($old_path.'/image3.png')}}" alt="">
                        </a>
                    </div>
                    <div class="scr-labl"></div>
                ...
                <div class="screenshot-itm">
                    <div class="screenshot-image">
                        <a href="{{asset($old_path.'/image4.png')}}" target="_blank" class="img-zoom">
                            <img src="{{asset($old_path.'/image4.png')}}" alt="">
                        </a>
                    </div>
                    <div class="scr-labl"></div>
                </div>
