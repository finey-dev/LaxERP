...
{{ Form::open(array('url' => 'workload-timesheet', 'class'=>'needs-validation', 'novalidate')) }}
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                {{ Form::textarea('notes', '', array('class' => 'form-control notes', 'placeholder' => 'Timesheet notes')) }}
            </div>
        </div>
    </div>
</div>
