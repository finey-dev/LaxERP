...
class PermissionTableSeeder extends Seeder
{
     public function run()
    {
        ...
        $permissions  = [
            'workload manage',
            'workload overview manage',
            'workload settings manage',
            'staff settings manage',
            'staff settings create',
            'staff settings edit',
            'staff settings delete',
            'workload holidays manage',
            'workload holidays create',
            'workload holidays edit',
            'workload holidays delete',
            'workload holiday import',
        ];
