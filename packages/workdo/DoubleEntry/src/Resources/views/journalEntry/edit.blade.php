...
@section('content')
    {{ Form::model($journalEntry, ['route' => ['journal-entry.update', $journalEntry->id], 'method' => 'PUT', 'class' => 'w-100', 'enctype' => 'multipart/form-data','class'=>'needs-validation','novalidate']) }}
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"
                                    value="{{ \Workdo\DoubleEntry\Entities\JournalEntry::journalNumberFormat($journalEntry->journal_id) }}"
                                    readonly>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4">
    ...
    <div class="modal-footer mb-3">
        <input type="button" value="{{__('Cancel')}}" onclick="location.href = '{{route('journal-entry.index')}}';" class="btn btn-light me-2">
