                                    ...
                                    <table class="table table-flush" id="report-dataTable">
                                        ...
                                        @foreach ($resultArray as $receivableCustomer)
                                            <tr>
                                                ...
                                                <td> {{ !empty($receivableCustomer['credit_price']) ?currency_format_with_sym($receivableCustomer['credit_price']) :currency_format_with_sym(0) }}
                                                </td>
                                                <td class="text-end">
                                                    {{currency_format_with_sym($balance) }} </td>
                                            </tr>
                                        @endforeach
                                        @if ($receivableCustomers != [])
                                            <tr>
                                                ...
                                                <td></td>
                                                <td></td>
                                                <th class="text-end">{{currency_format_with_sym($total) }}
                                                </th>
                                            </tr>
                                        @endif
                                        </tbody>
                                ...
                                @elseif($reportName == '#aging_summary')
                                    <table class="table table-flush" id="report-dataTable">
                                        ...
                                        @foreach ($agingSummaries as $key => $agingSummary)
                                            <tr>
                                                <td> {{ $key }}</td>
                                                <td>{{currency_format_with_sym($agingSummary['current']) }}
                                                </td>
                                                <td>{{currency_format_with_sym($agingSummary['1_15_days']) }}
                                                </td>
                                                <td>{{currency_format_with_sym($agingSummary['16_30_days']) }}
                                                </td>
                                                <td>{{currency_format_with_sym($agingSummary['31_45_days']) }}
                                                </td>
                                                <td>{{currency_format_with_sym($agingSummary['greater_than_45_days']) }}
                                                </td>
                                                <td>{{currency_format_with_sym($agingSummary['total_due']) }}
                                                </td>
                                            </tr>
