                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="tab-content" id="myTabContent2">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($payableSummary['status'] == 0)
                                                        <span
                                                            class="">{{ __(\App\Models\Invoice::$statues[$payableSummary['status']]) }}</span>
                                ...
                                @elseif($reportName == '#payable_details')
                                    <table class="table table-flush" id="report-dataTable">
                                        <thead>
                                        <tr>
                                            <th>{{ __('Vendor Name') }}</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($payableDetail['status'] == 0)
                                                        <span
                                                            class="">{{ __(\App\Models\Invoice::$statues[$payableDetail['status']]) }}</span>
                                        ...
                                        @foreach ($moreThan45 as $value)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($value['status'] == 0)
                                                        <span
                                                            class="">{{ __(Workdo\Account\Entities\Bill::$statues[$value['status']]) }}</span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($day31to45['status'] == 0)
                                                        <span
                                                            class="">{{ __(Workdo\Account\Entities\Bill::$statues[$day31to45['status']]) }}</span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($day16to30['status'] == 0)
                                                        <span
                                                            class="">{{ __(Workdo\Account\Entities\Bill::$statues[$day16to30['status']]) }}</span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($day1to15['status'] == 0)
                                                        <span
                                                            class="">{{ __(Workdo\Account\Entities\Bill::$statues[$day1to15['status']]) }}</span>
                                        ...
                                        @foreach ($currents as $current)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($current['status'] == 0)
                                                        <span
                                                            class="">{{ __(Workdo\Account\Entities\Bill::$statues[$current['status']]) }}</span>
