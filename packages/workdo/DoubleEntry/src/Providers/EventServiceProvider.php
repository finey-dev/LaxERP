...
use Workdo\DoubleEntry\Listeners\CompanyMenuListener;
use Workdo\DoubleEntry\Listeners\CompanySettingListener;
use Workdo\DoubleEntry\Listeners\CompanySettingMenuListener;
