...
use Workdo\DoubleEntry\Http\Controllers\JournalEntryController;
use Workdo\DoubleEntry\Http\Controllers\ReportController;

Route::group(['middleware' => ['web', 'auth', 'verified','PlanModuleCheck:DoubleEntry']], function () {
    ...
    Route::prefix('doubleentry')->group(function () {
        ...
        Route::post('journal-entry/setting/store', [JournalEntryController::class, 'setting'])->name('journal-entry.setting.store');
    });
});
