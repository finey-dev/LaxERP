@php
    $super_admin_settings = json_encode(getCompanyAllSetting());
@endphp
...
@section('content')
    {{ Form::open(['url' => 'budget', 'class' => 'w-100', 'class' => 'needs-validation', 'novalidate']) }}
    <div class="card bg-none card-box mt-3">
        <div class="card-body">
            <div class="row">
                ...
                <div class="form-group  col-md-4">
                    <div class="btn-box">
                        {{ Form::label('year', __('Year'), ['class' => 'form-label']) }}<x-required></x-required>
    ...
    <div class="modal-footer">
        <input type="button" value="{{ __('Cancel') }}" onclick="location.href = '{{ route('budget.index') }}';"
