...
class CompanyMenuListener
{
    ...
    public function handle(CompanyMenuEvent $event): void
    {
        ...
        $menu->add([
            'category' => 'Operations',
            'title' => __('Manufacture'),
            'icon' => 'ti ti-glass-full',
            'name' => 'manufacture-management',
            'parent' => null,
            'order' => 697,
            'ignore_if' => [],
            'depend_on' => [],
            'route' => '',
            'module' => $module,
            'permission' => 'manufacture dashboard manage'
        ]);
        $menu->add([
            'category' => 'Operations',
        ...
        $menu->add([
            ...
            'module' => $module,
            'permission' => 'manufacture-maintenance manage'
        ]);
