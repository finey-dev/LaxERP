...
@php
    $path = url("packages/workdo/SWOTAnalysisModel/src/marketplace");
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
            ...
            <div class="row row-gap align-items-center pdp-summery-row">
                <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                    <div class="pdp-summery">
                        ...
                        <p>{{__('The Dash SaaS SWOT Analysis Module empowers businesses with a structured framework to evaluate their Strengths, Weaknesses, Opportunities, and Threats. This powerful tool is designed to provide clear insights into your organizations internal and external factors, helping you make informed strategic decisions.')}}</p>
                        <div class="price">
    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="section-title text-center">
                <h2>{{__('Comprehensive SWOT Analysis')}}</h2>
                <p>{{__('The SWOT Analysis Module features an intuitive interface that simplifies the process of conducting thorough analyses.')}}</p>
            </div>
            <div class="row row-gap padding-bottom ">
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            <div class="subtitle">
                                <h2>{{__('Strength Identification')}}</h2>
                            </div>
                        </div>
                        <p>{{__("Uncover and document your business key strengths with the SWOT Analysis Module. By systematically evaluating areas where your company excels, you can leverage these strengths to maintain a competitive edge. Whether its your innovative products, exceptional customer service, or robust supply chain, this module helps you highlight and maximize your core competencies.")}} </p>
            ...
            <div class="row row-gap  padding-bottom">
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                                <h2>{{__('Weakness Assessment')}}</h2>
                            <p>{{__("Understanding and addressing weaknesses is crucial for growth. The SWOT Analysis Module allows you to identify internal areas that need improvement. By recognizing these vulnerabilities, whether they are resource limitations, operational inefficiencies, or skill gaps, you can develop targeted strategies to overcome them and bolster your business’s resilience.")}}</p>
                        </div>
            ...
            <div class="row row-gap align-items-center padding-bottom">
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                                <h2>{{__('Opportunity Exploration')}}</h2>
                            <p>{{__("Stay ahead of the curve by identifying potential opportunities in your market with the SWOT Analysis Module. Analyze emerging trends, market shifts, and unmet customer needs to find new avenues for growth and expansion. This proactive approach enables you to capitalize on favorable conditions and strategic openings, positioning your business for long-term success.
                            ")}} </p>
            ...
            <div class="row row-gap align-items-center padding-bottom">
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                                <h2>{{__('Threat Analysis')}}</h2>
                        </div>
                        <p>{{__("Prepare for potential challenges by thoroughly examining external threats with the SWOT Analysis Module. Evaluate factors such as competitive pressures, regulatory changes, and economic fluctuations that could impact your business. By understanding these threats, you can devise contingency plans and risk mitigation strategies to safeguard your operations.")}}</p>
                    </div>
                </div>
            </div>
            <div class="row row-gap align-items-center padding-bottom ">
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            <h2>{{__('User-Friendly Interface')}}</h2>
                        </div>
                        <p>{{__("The SWOT Analysis Module features an intuitive interface that simplifies the process of conducting thorough analyses. Easily input data, categorize insights, and generate comprehensive reports that provide a clear overview of your strategic position. This user-friendly design ensures that businesses of all sizes can effectively utilize the module to enhance their strategic planning.
                            ")}} </p>
                    </div>
                </div>
                <div class="col-lg-7 col-md-6 col-12">
