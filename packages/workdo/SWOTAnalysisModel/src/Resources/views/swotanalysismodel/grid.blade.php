...
<div class="d-flex">
    ...
    <a href="{{ route('swotanalysis-model.index') }}" class="btn btn-sm btn-primary btn-icon me-2"
        ...
        <div class="row  d-flex grid time-line-wrapper">
            ...
            <div class="d-flex col-sm-6 col-xl-4 col-xxl-3 All">
                <div class="card w-100">
                    <div class="card-header w-100 h-100 border-0 pb-0 p-3 mb-3">
                        <div class="h-100 d-flex gap-2 justify-content-between">
                            <h5>
                                <a href="{{ route('swotanalysis-model.show', $Charter->id) }}"
                            ...
                            <div class="dropdown-btn-wrp text-end">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <a href="#" data-url="{{ route('swotanalysis-model.receipt', $Charter->id) }}"
                                        data-size="lg" data-bs-whatever="{{ __('Print') }}" data-ajax-popup="true"
                                        class="dropdown-item" data-bs-toggle="tooltip"><i class="ti ti-printer me-1"></i>
                                        {{ __('Print') }}</a>


                                    @permission('SWOTAnalysisModel show')
                                    <a href="{{ route('swotanalysis-model.show', $Charter->id) }}" class="dropdown-item"
                                        data-bs-toggle="tooltip" data-bs-whatever="{{ __('View') }}">
                                    ...
                                    <a href="{{ route('swotanalysis-model.edit', $Charter->id) }}" data-size="md"
                                    ...
                                    {{ Form::open(['route' => ['swotanalysis-model.destroy', $Charter->id], 'class' => 'm-0']) }}
                                    @method('DELETE')
                                    <a href="#!" class="dropdown-item bs-pass-para show_confirm text-danger"
                    ...
                    <div class="card-body p-3 pt-0">
                        ...
                        <div class="bottom-center-wrp row g-2 align-items-center justify-content-between"
                            ...
                            <div class="col-auto">
                                ...
                                <div class="user-group">
                                    ...
                                    <img alt="image" data-bs-toggle="tooltip" data-bs-placement="top"
                                        title="{{ $user->name }}" @if ($user->avatar)
                                    src="{{ get_file($user->avatar) }}" @else src="{{ get_file('avatar.png') }}"
                                    @endif
            ...
            <div class="col-sm-6 col-xl-4 col-xxl-3  All mb-4">
                <a href="{{ route('swotanalysis-model.create', [0]) }}" class="btn-addnew-project border-primary"
                    data-title="{{ __('Create New SWOT Analysis Model') }}"
                    style="padding: 90px 10px   ; text-decoration: none;">
                    <div class="badge bg-primary proj-add-icon">
                        <i class="ti ti-plus"></i>
                    </div>
                    <h6 class="my-2 text-center">{{ __('New SWOT Analysis Model') }}</h6>
                    <p class="text-muted text-center">{{ __('Click here to add New') }} </p>
                </a>
            </div>
            @endpermission
            @endauth
...
<script src="{{ asset('packages/workdo/SWOTAnalysisModel/src/Resources/assets/js/moment-timezone.min.js') }}"></script>
