...
@section('page-title')
    {{ __('SWOT Analysis Model Details') }}
@endsection

@push('css')
    <link rel="stylesheet" href="{{ asset('packages/workdo/SWOTAnalysisModel/src/Resources/assets/css/custom.css') }}">
    <link rel="stylesheet"
        href="{{ asset('packages/workdo/SWOTAnalysisModel/src/Resources/assets/summernote/summernote-bs4.css') }}">
...
@section('page-action')
    <div>
        @if (URL::previous() == URL::current())
            <a href="{{ route('swotanalysis-model.index') }}" class="btn-submit btn btn-sm btn-primary " data-toggle="tooltip"
                title="{{ __('Back') }}">
        ...
        $(document).ready(function() {
            ...
            $('#stars li').on('click', function() {
                ...
                $('#stars li').on('click', function() {
                    ...
                    $.ajax({
                        url: '{{ route('swotanalysismodel.rating', $Charters->id) }}',
                        type: 'POST',
                        data: {
                            rating: ratingValue,
...
@section('content')
    <div class="row">
                ...
                <div class="col-md-3">
                    <div class="card sticky-top" style="top:30px">
                        <div class="list-group list-group-flush" id="useradd-sidenav">
                            ...
                            <a href="#strengths"
                                class="list-group-item list-group-item-action border-0">{{ __('Strengths') }}
                                <div class="float-end"><i class="ti ti-chevron-right"></i></div>
                            </a>
                            <a href="#weaknesses"
                                class="list-group-item list-group-item-action border-0">{{ __('Weaknesses') }}
                                <div class="float-end"><i class="ti ti-chevron-right"></i></div>
                            </a>
                            <a href="#opportunities"
                                class="list-group-item list-group-item-action border-0">{{ __('Opportunities') }}
                                <div class="float-end"><i class="ti ti-chevron-right"></i></div>
                            </a>
                            <a href="#threats" class="list-group-item list-group-item-action border-0">{{ __('Threats') }}
                                <div class="float-end"><i class="ti ti-chevron-right"></i></div>
                            </a>
                                            ...
                                            @else
                                                <video width="100%" controls>
                                                    <source id="videoresource"
                                                        src="{{ asset('Workdo/SWOTAnalysisModel/Resources/assets/img/no-video.jpg') }}"
                                                        type="image">
                                                </video>
                                            @endif
                                        </div>
                                            ...
                                            <div class="col-md-12 col-sm-4">
                                                <div class="d-flex align-items-start">
                                                    ...
                                                    <div class="ms-2">
                                                        ...
                                                        <h5 class="mb-0 text-primary">{{ $Charters->name }}</h5>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="d-flex align-items-start">
                                                    ...
                                                    <div class="ms-2">
                                                        ...
                                                        <h5 class="mb-0 text-warning">
                                                            {{ !empty($Charters->Status) ? $Charters->Status->name : '-' }}
                                                        </h5>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="d-flex align-items-start">
                                                    ...
                                                    <div class="ms-2">
                                                        ...
                                                        <h5 class="mb-0 text-info">
                                                            {{ !empty($Charters->Stage) ? $Charters->Stage->name : '-' }}
                                                        </h5>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 col-sm-4 mt-4">
                                                <div class="d-flex align-items-start">
                                                    ...
                                                    <div class="ms-2">
                                                        ...
                                                        <h5 class="mb-0 text-primary"> {{ $Charters->rating }}</h5>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 col-sm-4 mt-4">
                                                <div class="d-flex align-items-start">
                                                    ...
                                                    <div class="ms-2">
                                                        ...
                                                        <h5 class="mb-0 text-warning">
                                                            {{ company_date_formate($Charters['created_at']) }}</h5>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            {{ Form::open(['route' => ['swotanalysis-model.description.store', $Charters->id]]) }}
                                            ...
                                            @permission('SWOTAnalysisModel decription create')
                            ...
                            <div class="row ">
                                <div class="col-12">
                                    <div class="card">
                                        ...
                                        @php
                                            $attachments = json_decode($Charters->swotanalysismodel_attachments);
                                        @endphp
                                                    ...
                                                    <div class="list-group-item ">
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="action-btn  p-0 w-auto">
                                                                ...
                                                                <a class="bg-secondary btn btn-sm align-items-center"
                                                            ...
                                                            <div class="action-btn p-0 w-auto"
                                                                style="margin-right: 6px;margin-left: 5px;">
                                                                <a class=" bg-warning  btn btn-sm align-items-center"
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            {{ Form::open(['route' => ['swotanalysis.strength.store', $Charters->id]]) }}
                                            <textarea name="strengths"
                                                class="form-control summernote {{ !empty($errors->first('strengths')) ? 'is-invalid' : '' }}"
                                                id="description_ck1">{!! $Charters->strengths !!}</textarea>
                                            @permission('SWOTAnalysisModel Strengths create')
                                                <div class="col-md-12 text-end mb-0">
                                                    {{ Form::submit(__('Add'), ['class' => 'btn  btn-primary']) }}
                                                </div>
                                            @endpermission
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            {{ Form::open(['route' => ['swotanalysis-model.weakness.store', $Charters->id]]) }}
                                            <textarea name="weaknesses"
                                                class="form-control summernote {{ !empty($errors->first('weaknesses')) ? 'is-invalid' : '' }}"
                                                id="description_ck2">{!! $Charters->weaknesses !!}</textarea>
                                            @permission('SWOTAnalysisModel Weaknesses create')
                                                <div class="col-md-12 text-end mb-0">
                                                    {{ Form::submit(__('Add'), ['class' => 'btn  btn-primary']) }}
                                                </div>
                                            @endpermission
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            {{ Form::open(['route' => ['swotanalysis-model.opportunities.store', $Charters->id]]) }}
                                            <textarea name="opportunities"
                                                class="form-control summernote {{ !empty($errors->first('opportunities')) ? 'is-invalid' : '' }}"
                                                id="description_ck5">{!! $Charters->opportunities !!}</textarea>
                                            @permission('SWOTAnalysisModel Opportunities create')
                                                <div class="col-md-12 text-end mb-0">
                                                    {{ Form::submit(__('Add'), ['class' => 'btn  btn-primary']) }}
                                                </div>
                                            @endpermission
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            {{ Form::open(['route' => ['swotanalysis-model.threats.store', $Charters->id]]) }}
                                            <textarea name="threats" class="form-control summernote {{ !empty($errors->first('threats')) ? 'is-invalid' : '' }}"
                                                id="description_ck6">{!! $Charters->threats !!}</textarea>
                                            @permission('SWOTAnalysisModel Threats create')
                                                <div class="col-md-12 text-end mb-0">
                                                    {{ Form::submit(__('Add'), ['class' => 'btn  btn-primary']) }}
                                                </div>
                                            @endpermission
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            {{ Form::open(['route' => ['swotanalysis-model.notes.store', $Charters->id]]) }}
                                            ...
                                            @permission('SWOTAnalysisModel notes create')
                                                <div class="col-md-12 text-end mb-0">
                                                    {{ Form::submit(__('Add'), ['class' => 'btn  btn-primary']) }}
                                                </div>
                                            @endpermission
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="media comment-card mb-2 rounded border-1 border border-primary">
                                            ...
                                            <div class="media-body ms-2">
                                                ...
                                                <div class="d-flex gap-2 align-items-center">
                                                    ...
                                                    <div  class="d-flex align-items-center">
                                                        ...
                                                        @permission('SWOTAnalysisModel comment replay')
                                                            <div class="d-flex me-2">
                                                                <a href="!#"
                                                                    data-url="{{ route('swotanalysismodel.comment.reply', [$Charters->id, $comment->id]) }}"
                                                                    class="btn btn-sm p-1 d-inline-flex align-items-center text-white "
                                                ...
                                                @foreach ($comment->subComment as $subComment)
                                                    @include(
                                                        'swotanalysis-model::swotanalysismodel.comment',
                                                        [
                                    ...
                                    <div class="border rounded mt-4">
                                        {{ Form::open(['route' => ['swotanalysismodel.comment.store', $Charters->id], 'enctype' => 'multipart/form-data', 'class' => 'd-flex align-items-center gap-3']) }}
        ...
        @push('scripts')
            ...
            <script src="{{ asset('packages/workdo/SWOTAnalysisModel/src/Resources/assets/summernote/summernote-bs4.js') }}">
            </script>
            <script src="{{ asset('/js/custom.js') }}"></script>
            {{-- <script src="{{ asset('assets/js/plugins/summernote-0.8.18-dist/summernote-lite.min.js') }}"></script> --}}
            <script src="{{ asset('packages/workdo/SWOTAnalysisModel/src/Resources/assets/js/moment.js') }}"></script>
            <script src="{{ asset('packages/workdo/SWOTAnalysisModel/src/Resources/assets/js/moment-timezone.min.js') }}">
            </script>

            <script src="{{ asset('packages/workdo/SWOTAnalysisModel/src/Resources/assets/js/main.js') }}"></script>
            <script>
