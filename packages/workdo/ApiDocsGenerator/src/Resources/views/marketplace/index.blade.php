...
@php
    $path = ("packages/workdo/".$module->name."/src/marketplace");
    $marketplace = \Workdo\LandingPage\Entities\MarketplacePageSetting::settings($module->name);
            ...
            <div class="row row-gap align-items-center pdp-summery-row">
                <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                    <div class="pdp-summery">
                        ...
                        <p>{{__('With WorkDo Dash API, you have the tools you need to enhance your application project and task management capabilities. Dive into the documentation, explore the endpoints, and see how WorkDo Dash can elevate your projects.')}}</p>
                        <div class="price">
                ...
                <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                    <div class="pdp-image-wrapper">
                        <div class="pdp-media banner-img-wrapper">
                            ...
                            <img src="{{asset($path.'/image1.png')}}" alt="" class="inner-frame-img">
                       </div>
                    </div>
                </div>
            </div>
    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="section-title text-center">
                <h2>{{__('API')}}</h2>
                <p>{{__('This module allows you to enable REST API functionality ')}}</p>
            </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('Why use API?')}}</h2>
                        </div>
                        <p>{{__('The WorkDo Dash API unlocks the potential for you to tailor our platform to your specific needs.')}}</p>
                    </div>
                </div>
                <div class="col-lg-7 col-md-6 col-12">
                    <div class="dash-theme-preview">
                        <img src="{{asset($path.'/image2.png')}}" alt="">
                    </div>
                </div>
            </div>
            <div class="row row-gap align-items-center ">
                <div class="col-lg-7 col-md-6 col-12">
                    <div class="dash-theme-preview">
                        <img src="{{asset($path.'/image3.png')}}" alt="">
                    </div>
                </div>
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        ...
                        <p>{{__('It includes a variety of useful commands in order to control your WorkDo Dash installation remotely, build third party connections and access WorkDo Dash information in real-time!')}}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="screenshot-slider">
                <div class="screenshot-itm">
                    <div class="screenshot-image">
                        <a href="{{asset($path.'/image1.png')}}" target="_blank" class="img-zoom">
                            <img src="{{asset($path.'/image1.png')}}" alt="">
                        </a>
                    </div>
                </div>
                <div class="screenshot-itm">
                    <div class="screenshot-image">
                        <a href="{{asset($path.'/image2.png')}}" target="_blank" class="img-zoom">
                            <img src="{{asset($path.'/image2.png')}}" alt="">
                        </a>
                    </div>
                </div>
                <div class="screenshot-itm">
                    <div class="screenshot-image">
                        <a href="{{asset($path.'/image3.png')}}" target="_blank" class="img-zoom">
                            <img src="{{asset($path.'/image3.png')}}" alt="">
                        </a>
                    </div>
                </div>
                <div class="screenshot-itm">
                    <div class="screenshot-image">
                        <a href="{{asset($path.'/image4.png')}}" target="_blank" class="img-zoom">
                            <img src="{{asset($path.'/image4.png')}}" alt="">
                        </a>
                    </div>
                </div>
                <div class="screenshot-itm">
                    <div class="screenshot-image">
                        <a href="{{asset($path.'/image5.png')}}" target="_blank" class="img-zoom">
                            <img src="{{asset($path.'/image5.png')}}" alt="">
                        </a>
                    </div>
                </div>
                <div class="screenshot-itm">
                        ...
                        <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 col-12 product-card">
                            <div class="product-card-inner">
                                ...
                                <div class="product-content">
                                    <h4> <a href="product.html">{{ $module->name }}</a> </h4>
                                    <div class="price">
                                        <ins><span class="currency-type">{{ super_currency_format_with_sym($module->monthly_price) }}</span> <span class="time-lbl text-muted">{{ __('/Month') }}</span></ins>
                                                    <ins><span class="currency-type">{{ super_currency_format_with_sym($module->yearly_price) }}</span> <span class="time-lbl text-muted">{{ __('/Year') }}</span></ins>
                                    </div>
                                    <a href="{{ route('software.details',$module->name) }}" target="_new"  class="btn cart-btn">View Details</a>
                                </div>
                            </div>
                        </div>
                        @endif
