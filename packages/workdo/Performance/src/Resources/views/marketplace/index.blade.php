...
@php
    $path = url("packages/workdo/Performance/src/marketplace");
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
            ...
            <div class="row row-gap align-items-center pdp-summery-row">
                <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                    <div class="pdp-summery">
                        ...
                        <p>{{__('Boost employee productivity with custom KPIs. Track employee performance, share feedback, and help them reach company targets. Depending on Hrm Module.')}}</p>
                        <div class="price">
    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="section-title text-center">
                <h2>{{__('Help Your ')}}<b>{{__('Employees')}}</b>{{__(' Become More Productive')}}</h2>
                <p>{{__('Set benchmarks and grade your employee performance. Find top-performers and reward them for their hard work and improvement.')}}</p>
            </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('Rating System')}}</h2>
                        </div>
                        <p>{{__('Empower employee growth. Schedule skills training, track expenses, and watch your employees become better at their work. Boost employee productivity with custom KPIs. Track employee performance, share feedback, and help them reach company targets.Give the stars your employee on their performance.Pick key areas and skills and create a rating system to help your employees understand where they need to improve.')}}</p>
                    </div>
                </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('Indicator Appraisal')}}</h2>
                        </div>
                        <p>{{__('
                            Get a clear overview of the performance of your departments. Identify areas
                    of improvement in real-time, and streamline processes for better
                    performance.')}}</p>
                    </div>
                </div>
            </div>
            <div class="row row-gap align-items-center padding-bottom padding-top">
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            <div class="subtitle">
                            ...
                            <h2>{{__('Goal Tracking System')}}</h2>
                        </div>
                        <p>{{__('Experience the transformative impact of transparent goal setting and tracking with Gole System`s intuitive interface. Drive your organization`s success by aligning your team`s efforts and achieving excellence together. ')}}</p>
                    </div>
                </div>
                <div class="col-lg-7 col-md-6 col-12">
                    <div class="dash-theme-preview">
