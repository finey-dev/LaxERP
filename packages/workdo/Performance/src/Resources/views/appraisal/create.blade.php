    ...
    <div class="row">
        ...
        <div class="col-md-6 mt-2">
            <div class="form-group">
                ...
                <div class="employee_div">
                    <select name="employee" id="employee" class="form-control" placeholder="{{__('Select Employee')}}" required>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                {{ Form::month('appraisal_date', '', ['class' => 'form-control ', 'autocomplete' => 'off', 'min' => date('Y-m'), 'required' => 'required']) }}
            </div>
        </div>
        <div class="col-md-12">
            <div class="form-group">
