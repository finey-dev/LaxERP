...
<div class="modal-body">
    <div class="row">
        <div class="col-md-12 mb-6">
            {{ Form::label('file', __('Download Sample Assets CSV File'), ['class' => 'form-label text-danger mx-1']) }}
            @if(check_file('uploads/sample/sample_assets.csv'))
                <a href="{{ asset('uploads/sample/sample_assets.csv') }}"
...
<div class="modal-footer">
    ...
    <a href="" data-url="{{ route('assets.import.modal') }}" data-ajax-popup-over="true" title="{{ __('Create') }}" data-size="xl" data-title="{{ __('Import Assets CSV Data') }}"  class="d-none import_modal_show"></a>
</div>
{{ Form::close() }}
