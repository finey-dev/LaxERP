...
@php
    $path = url("packages/workdo/FixEquipment/src/marketplace");
                ...
                <div class="row row-gap align-items-center pdp-summery-row">
                    <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                        <div class="pdp-summery">
                            ...
                            <p>{{ __('The Fix Equipment System is a powerful solution for managing and tracking various types of equipment within your organization. It is designed to simplify the process of categorizing, auditing, and maintaining different equipment items.') }}
                            </p>
                            <div class="price">
                                <ins><span
                                        class="currency-type">{{ super_currency_format_with_sym($module->monthly_price) }}</span><span
                                        class="time-lbl">{{ __('/Month') }}</span></ins>
                                <ins><span
                                        class="currency-type">{{ super_currency_format_with_sym($module->yearly_price) }}</span><span
                                        class="time-lbl">{{ __('/Year') }}</span></ins>
                            </div>
        ...
        <section class="dedicated-themes-section padding-bottom">
            <div class="container">
                <div class="section-title text-center">
                    <h2>{{ __('Managing ') }}<b>{{ __(' Equipment ') }}</b> {{ __('') }}</h2>
                    <p>{{ __('Manage equipment effortlessly with Fix Equipment. Streamline tracking, maintenance, audits, and more, ensuring optimal efficiency and cost control for your organization.') }}
                    </p>
                </div>
                <div class="row row-gap padding-bottom ">
                    <div class="col-lg-5 col-md-6 col-12">
                        <div class="abt-theme">
                            <div class="section-title">
                                <h2>{{ __('Organizing Your Equipment') }}</h2>
                            </div>
                            <p>{{ __('Effortlessly organize your equipment with Fix Equipment management software.') }}
                            </p>
                            <div class="theme-acnav">
                                <div class="set has-children">
                                    <a href="javascript:;" class="acnav-label">
                                        ...
                                        <span>{{ __('Enhance Efficiency') }}</span>
                                    </a>
                                    <div class="acnav-list">
                                        <p>{{ __('Streamline equipment management for improved productivity with Fix Equipment software.') }}
                                        </p>
                                    </div>
                                </div>
                                <div class="set has-children">
                                    <a href="javascript:;" class="acnav-label">
                                        ...
                                        <span>{{ __('Efficient Audit') }}</span>
                                    </a>
                                    <div class="acnav-list">
                                        <p>{{ __(' Streamlined processes for comprehensive equipment auditing and compliance management.') }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row row-gap  padding-bottom">
                    ...
                    <div class="col-lg-5 col-md-6 col-12">
                        <div class="abt-theme">
                            <div class="section-title">
                                <h2>{{ __('Asset & Maintenance Management') }}</h2>
                            </div>
                            <p>{{ __('Establish module for managing equipment, facilities, vehicles and other assets based on industry standards. Keep track of individual assets and schedule, assign and record maintenance work.') }}
                            </p>
                            <div class="theme-acnav">
                                <div class="set has-children">
                                    <a href="javascript:;" class="acnav-label">
                                        ...
                                        <span>{{ __('Maintenance Management') }}</span>
                                    </a>
                                    <div class="acnav-list">
                                        <p>{{ __('Efficient preventive and corrective maintenance scheduling helps extend asset life, minimize downtime, and reduce operational disruptions.') }}
                                        </p>
                                    </div>
                                </div>
                                <div class="set has-children">
                                    <a href="javascript:;" class="acnav-label">
                                        ...
                                        <span>{{ __('Depreciation Tracking') }}</span>
                                    </a>
                                    <div class="acnav-list">
                                        <p>{{ __('Accurately calculate asset depreciation, ensuring financial transparency and compliance with accounting standards.') }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row row-gap align-items-center padding-bottom">
                    <div class="col-lg-5 col-md-6 col-12">
                        <div class="abt-theme">
                            <div class="section-title">
                                <h2>{{ __('Market-Specific Benefits') }}</h2>
                            </div>
                            <p>{{ __('The Fix Equipment Module caters to a wide range of industries, including manufacturing, healthcare, transportation, and more. Each sector can benefit from module-specific features tailored to their unique asset management needs.') }}
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-7 col-md-6 col-12">
                ...
                <div class="row row-gap align-items-center ">
                    ...
                    <div class="col-lg-5 col-md-6 col-12">
                        <div class="abt-theme">
                            <div class="section-title">
                                <h2>{{ __('Equipment Categories') }}</h2>
                            </div>
                            <p>{{ __('Equipment categories are the foundation of a well-organized equipment management system. They provide a structured approach to classifying assets based on their type, purpose, and characteristics.') }}
                            </p>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="tabs-container">
                                    <div class="tab-content active" id="tab-1">
                                        <div class="pricing-content">
                                            <div class="price">
                                                <ins><span
                                                        class="currency-type"></span>{{ super_currency_format_with_sym($module->monthly_price) }}<span
                                                        class="time-lbl">{{ __('/Month') }}</span></ins>
                                            </div>
                                            <div class="lbl">{{ __('Billed month, or') }}
                                    ...
                                    <div class="tab-content" id="tab-2">
                                        <div class="pricing-content">
                                            <div class="price">
                                                <ins><span
                                                        class="currency-type"></span>{{ super_currency_format_with_sym($module->yearly_price) }}<span
