@permission('consumables edit')
    <div class="action-btn me-2">
        <a class="btn btn-sm  bg-info align-items-center" data-url="{{ route('fix.equipment.component.edit', $component->id) }}"
            data-ajax-popup="true" data-size="md" data-bs-toggle="tooltip" title="{{ __('Edit') }}"
            data-bs-original-title="{{ __('Edit') }}" data-title="{{ __('Edit Component') }}">
...
@permission('consumables delete')
    <div class="action-btn">
        ...
        <a class="btn btn-sm  bg-danger align-items-center bs-pass-para show_confirm" data-bs-toggle="tooltip"
            ...
            data-confirm-yes="delete-form-{{ $component['id'] }}">
