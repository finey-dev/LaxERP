...
<link rel="icon" href="{{ check_file($favicon) ? get_file($favicon) : get_file('uploads/logo/favicon.png') }}{{ '?' . time() }}" type="image/x-icon" />
 ...
 <!-- font css -->
 <link rel="stylesheet" href="{{ asset('packages/workdo/Procurement/src/Resources/assets/css/site.css') }}" id="stylesheet">
 <link rel="stylesheet" href="{{ asset('packages/workdo/Procurement/src/Resources/assets/css/custom.css') }}">
        ...
        @if( isset($company_settings['cust_darklayout']) &&  $company_settings['cust_darklayout'] == 'on')
            ...
            <link rel="stylesheet" href="{{ asset('packages/workdo/Procurement/src/Resources/assets/css/custom-dark.css') }}">
        @else
            <link rel="stylesheet" href="{{ asset('assets/css/style.css') }}" id="main-style-link">
        @endif

 <script src="{{ asset('js/jquery.min.js') }}"></script>
 <link rel="stylesheet" href="{{ asset('packages/workdo/Procurement/src/Resources/assets/css/nprogress.css') }}" >
 <link rel="stylesheet" href="{{ asset('assets/fonts/tabler-icons.min.css') }}">
 <link rel="stylesheet" href="{{ asset('assets/fonts/fontawesome.css') }}">

@stack('css')

<script src="{{ asset('packages/workdo/Procurement/src/Resources/assets/js/nprogress.js') }}"></script>
</head>
