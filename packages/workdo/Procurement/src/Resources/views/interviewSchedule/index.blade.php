...
@section('page-action')
    <div>
        @permission('rfx interview schedule create')
            <a data-url="{{ route('rfx-interview-schedule.create') }}" data-ajax-popup="true"
                data-title="{{ __('Create Interview Schedule') }}" data-bs-toggle="tooltip" title=""
                        ...
                        <li class="list-group-item card mb-3">
                                            ...
                                            <div class="px-3">
                                                <div class="row align-items-center">
                                                    <div class="col ml-n2 text-sm mb-0 fc-event-title-container">
                                                        ...
                                                        <div class="card-text small text-dark">
                                                            {{ company_date_formate($schedule->date) . ' ' . company_datetime_formate($schedule->time) }}
                                                        </div>
                                                    </div>
                                                    <div class="col-auto text-right">
                                                            @permission('rfx interview schedule edit')
                                                                <div class="action-btn  me-2">
                                                                    <a class="mx-3 btn bg-info btn-sm  align-items-center"
                                                                        data-url="{{ route('rfx-interview-schedule.edit', $schedule->id) }}"
                                                                        data-ajax-popup="true" data-title="{{ __('Edit Interview Schedule') }}"
                                                            ...
                                                            @endpermission
                                                            @permission('rfx interview schedule delete')
                                                                <div class="action-btn">
                                                                    {!! Form::open([
                                                                        'method' => 'DELETE',
                                                                        'route' => ['rfx-interview-schedule.destroy', $schedule->id],
                            ...
                            @empty
                                <div class="text-center">
                                    <h6>{{ __('There is no Interview Schedule Create') }}</h6>
                                </div>
                            @endforelse
                        </li>
                    </ul>
...
@push('scripts')
    ...
    <script>
        $(document).on('click', '.fc-daygrid-event', function(e) {
            ...
            $("#commonModal .modal-title ").html(ucFirst(title));
