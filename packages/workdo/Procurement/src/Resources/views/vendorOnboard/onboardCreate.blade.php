{{ Form::open(['route' => ['vendor.on.board.store', $id], 'method' => 'post','class'=>'needs-validation','novalidate']) }}
<div class="modal-body">
    <div class="row">
        @if ($id == 0)
            <div class="form-group col-md-12">
                {{ Form::label('application', __('Interviewer'), ['class' => 'form-label']) }}<x-required></x-required>
        ...
        <div class="form-group col-md-12">
            ...
            {!! Form::date('joining_date', null, ['class' => 'form-control ','autocomplete'=>'off','min' => \Carbon\Carbon::now()->format('Y-m-d'), 'required' => 'required']) !!}
        </div>

        <div class="form-group col-md-6">
            {!! Form::label('days_of_week', __('Days Of Week'), ['class' => 'form-label']) !!}
            {!! Form::number('days_of_week', null, ['class' => 'form-control ','autocomplete'=>'off','min'=>'0','placeholder'=>'Enter Days Of Week']) !!}
        </div>
        <div class="form-group col-md-6">
