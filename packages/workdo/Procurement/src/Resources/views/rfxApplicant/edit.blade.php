                ...
                <div class="card-body">
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade  show active }}" id="details-tab" role="tabpanel"
                            ...
                            {{ Form::model($rfx_applicants, ['route' => ['rfx-applicant.update', $rfx_applicants->id], 'method' => 'PUT', 'enctype' => 'multipart/form-data','class'=>'needs-validation','novalidate']) }}
                            <div class="row">
                                    ...
                                    <div class="d-flex radio-check">
                                        <div class="form-check form-check-inline form-group">
                                            <input type="radio" id="g_male" value="Male" name="gender"
                                                ...
                                                {{ isset($rfx_applicants->gender) && $rfx_applicants->gender == 'Male' ? 'checked' : '' }}>
                                            <label class="form-check-label" for="g_male">{{ __('Male') }}</label>
                                        </div>
                                        <div class="form-check form-check-inline form-group">
                                            <input type="radio" id="g_female" value="Female" name="gender"
                                                class="form-check-input"
                                                {{ isset($rfx_applicants->gender) && $rfx_applicants->gender == 'Female' ? 'checked' : '' }}>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="choose-file form-group">
                                        <label for="profile" class="form-label d-block">
                                            ...
                                            <hr>
                                            <div class="mt-1">
                                                <img src="@if ($rfx_applicants->profile) {{ get_file($rfx_applicants->profile) }} @endif" id="blah" width="15%" />
                                            </div>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="choose-file form-group">
                                        <label for="proposal" class="form-label d-block">
                                            ...
                                            <hr>
                                            <div class="mt-1">
                                                <img src="@if ($rfx_applicants->proposal) {{ get_file($rfx_applicants->proposal) }} @endif" id="blah1" width="15%" />
                                            </div>
                                        </label>
                                    </div>
                                </div>
