...
<div class="">
    ...
    <ul class="nav nav-pills nav-fill cust-nav information-tab mt-2 d-flex justify-content-start" id="pills-tab" role="tablist">
...
@push('scripts')
    ...
    <script>
        ...
        $("#nextButton").click(function() {
            ...
            let requiredCheckboxesChecked = false;
            $('.required-checkbox').each(function() {
                if ($(this).is(':checked')) {
                    requiredCheckboxesChecked = true;
                    return false; // Break the loop early if a required checkbox is checked
                }
            });

            let requiredQuestionsCount = $('.required-checkbox').length;
            let checkedRequiredQuestions = $('.required-checkbox:checked').length;

            if (requiredQuestionsCount !== checkedRequiredQuestions) {
                allFieldsFilled = false;
                $('#required_checkbox_validation').removeClass('d-none');
            } else {
                $('#required_checkbox_validation').addClass('d-none');
            }
...
@section('content')
    <div class="row">
        {{ Form::open(['route' => ['rfx.store'], 'class' => 'w-100']) }}
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text" class="form-control skill_data" value=""
                                                    data-toggle="tags" name="skill" placeholder="{{__('Skill')}}" />
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" name="billing_type" required="" id="billing_type">
                                    ...
                                    <option value="items">{{ __('Item') }}</option>
                                    <option value="rfx">{{ __('RFx') }}</option>
                                </select>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="javascript:;" data-repeater-delete
                                                                    class="btn btn-sm btn-danger bs-pass-para repeater-action-btn">
                                                ...
                                                <table class="table mb-0 rfx-item" data-repeater-list="rfx"
                                                    ...
                                                    <tbody class="ui-sortable" data-repeater-item>
                                                        <tr clas="hgh">
                                                            ...
                                                            <td>
                                                                <div class="form-group">
                                                                    <textarea name="rfx_description" class="form-control pro_description" rows="2"
