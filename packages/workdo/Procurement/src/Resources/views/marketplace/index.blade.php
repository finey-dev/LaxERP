...
@php
    $path = url('packages/workdo/Procurement/src/marketplace');
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
                ...
                <div class="row row-gap align-items-center pdp-summery-row">
                    <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                        <div class="pdp-summery">
                            ...
                            <p>{{ __('Managing the procurement process can be a time-consuming and complex task.  Dash SaaS simplifies this process by providing a central hub for all your procurement needs.  Create purchase orders, manage vendor information, track spending, and gain real-time insights into your procurement activities – all within a user-friendly interface.') }}
                            </p>
                            <div class="price">
                                <ins><span
        ...
        <section class="dedicated-themes-section padding-bottom">
            <div class="container">
                <div class="section-title text-center">
                    <h2>{{ __('Comprehensive') }}<b>{{ __(' Procurement') }}</b>{{ __('Oversight') }}</h2>
                    <p>{{ __('Dash SaaS ensures compliance and seamless integration with your existing systems, providing comprehensive records and enhanced transparency for streamlined procurement operations.') }}
                    </p>
                </div>
                <div class="row row-gap padding-bottom ">
                    <div class="col-lg-5 col-md-6 col-12">
                        <div class="abt-theme">
                            <div class="section-title">
                                <div class="section-title">
                                    <h2>{{ __('Boost Efficiency with Automated Workflows') }}</h2>
                                </div>
                                <p>{{ __("Automate repetitive tasks and eliminate manual data entry with Dash SaaS's built-in workflows.  Standardize your procurement process by setting up approval chains for purchase orders and ensure all necessary steps are completed before finalizing transactions.  This not only saves time but also minimizes errors and improves overall efficiency.
                                ") }}
                                </p>
                            </div>
                        </div>
                ...
                <div class="row row-gap align-items-center padding-bottom">
                    ...
                    <div class="row row-gap align-items-center ">
                        ...
                        <div class="col-lg-5 col-md-6 col-12">
                            <div class="abt-theme">
                                <div class="section-title">
                                    <h2>{{ __('Streamlined Compliance and Audit Readiness') }}</h2>
                                </div>
                                <p>{{ __("Ensure compliance with organizational policies and regulatory requirements using Dash SaaS's robust procurement module. Maintain comprehensive records of all procurement activities, including approvals, transactions, and communications. This centralized record-keeping not only simplifies audit processes but also enhances transparency and accountability across your procurement operations.
                                ") }}
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="row row-gap align-items-center padding-bottom">
                        <div class="col-lg-5 col-md-6 col-12">
                            <div class="abt-theme">
                                <div class="section-title">
                                    <h2>{{ __('Flexible Integration with Existing Systems') }}</h2>
                                </div>
                                <p>{{ __('Dash SaaS seamlessly integrates with your existing ERP and financial systems, allowing for smooth data flow and reducing the need for duplicate data entry. By connecting with your current tools, you can ensure consistency and accuracy across your procurement and financial data. This flexible integration supports a cohesive and streamlined procurement process, enhancing overall productivity and data integrity.
                                ') }}
                                </p>
                            </div>
                        </div>
        ...
        <section class="bg-white padding-top padding-bottom ">
            <div class="container">
                <div class="section-title text-center">
                    ...
                    <p>{{ __('Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry standard dummy text ever since the 1500s,') }}
                    </p>
                </div>
                @if (count($modules) > 0)
                                    ...
                                    <div class="product-card-inner">
                                        ...
                                        <div class="product-content">
                                            ...
                                            <a href="{{ route('software.details', $module->alias) }}" target="_new"
                                                class="btn cart-btn">View Details</a>
                                        </div>
                                    </div>
                                </div>
                            @endif
