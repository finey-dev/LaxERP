...
@endphp
{{ Form::open(['url' => 'training', 'method' => 'post', 'class' => 'needs-validation', 'novalidate']) }}
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                {{ Form::date('start_date', null, ['class' => 'form-control ', 'autocomplete' => 'off', 'min' => date('Y-m-d'), 'required' => 'required']) }}
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
