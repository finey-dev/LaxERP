...
@php
    $path = url("/packages/workdo/BiometricAttendance/src/marketplace");
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="section-title text-center">
                <h2>{{__('Efficient ')}}<b>{{__('Time')}}</b>{{__(' Tracking')}}</h2>
                <p>{{__('Implementing biometric attendance streamlines time tracking and enhances security.')}}</p>
            </div>
                        ...
                        <div class="theme-acnav">
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Convenient System Settings')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Customize your attendance management system to suit your organization\'s needs. Our system setup page allows you to configure various system settings With Dash SaaS, you have full control over how attendance is tracked and managed within your organization.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Enhanced Security and Accuracy')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Customize your attendance management system with Dash SaaS by configuring working hours, overtime rules, and holiday calendars, but exclusively available with ZKTeco software integration. By entering ZKTeco API credentials, an auth token is generated, enabling seamless integration with the Dash SaaS biometric attendance module. Once integrated, you gain full control over system settings, and attendance history is conveniently presented within Dash SaaS, providing comprehensive insights into your organization\'s attendance tracking.')}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="theme-acnav">
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Comprehensive Attendance History')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Keep track of your employees\' attendance history with ease. Our module provides a detailed overview of each employee\'s attendance records, allowing you to monitor trends and identify any patterns or discrepancies. Whether you need daily, weekly, or monthly reports, Dash SaaS has you covered.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Seamless Data Sync with HRM Module')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Syncing attendance data with your HRM system has never been easier. With the click of a button, you can seamlessly transfer attendance records from the Biometric attendance module to the HRM module, ensuring consistency across all your HR processes. Our sync feature saves you time and eliminates the need for manual data entry, reducing the risk of errors.')}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
