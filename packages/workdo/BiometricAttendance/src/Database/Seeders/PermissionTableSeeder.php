...
class PermissionTableSeeder extends Seeder
{
     public function run()
    {
        ...
        $permissions  = [
            'biometricattendances manage',
            'biometricattendance manage',
            'biometricattendance synchronize',
            'biometricsetting manage',
            'biometricsetting create',
            'biometricsetting edit',
            'biometricsetting delete',
        ];
