...
class MarketPlaceController extends Controller
{
    public function marketplaceindex($slug = null)
    {
        if(\Auth::user()->isAbleTo('landingpage manage')){
            ...
            return view('landingpage::marketplace.product_main.index',compact('settings','slug','module'));
        }else{
    ...
    public function dedicatedindex($slug = null)
    {
        ...
        if(\Auth::user()->isAbleTo('landingpage manage')){
            ...
            return view('landingpage::marketplace.dedicated.index',compact('settings','slug','dedicated_theme_sections','module'));
    ...
    public function dedicated_theme_header_store(Request $request , $slug)
    {
        ...
        return redirect()->back()->with(['success'=> 'The details has been saved successfully']);
    ...
    public function dedicated_theme_store(Request $request , $slug)
    {
        ...
        return redirect()->back()->with(['success'=> 'The section has been added successfully']);
    }

    public function dedicated_theme_edit($slug, $key, $no){
        if(!isset($slug)){
            return redirect()->back()->with('error',__('Module Not Found.'));
         }
         else{
        ...
        return view('landingpage::marketplace.dedicated.edit', compact('dedicated_theme','key','slug','no','module'));
    }
    ...
    public function dedicated_theme_update(Request $request, $slug ,$key)
    {
        ...
        return redirect()->back()->with(['success'=> 'The dedicated theme section are updated successfully']);
    }
    ...
    public function dedicated_theme_delete($slug , $key)
    {
        ...
        return redirect()->back()->with(['success'=> 'The dedicated theme section has been deleted']);
    }
    ...
    public function whychoose_store(Request $request , $slug)
    {
        ...
        return redirect()->back()->with(['success'=> 'The Why Choose Section has been Added successfully']);
    }
    ...
    public function screenshots_store(Request $request , $slug)
    {
        ...
        return redirect()->back()->with(['success'=> 'The screenshots has been added successfully']);
    }
    ...
    public function screenshots_update(Request $request, $slug , $key){
        ...
        return redirect()->back()->with(['success'=> 'The screenshots details are update successfully']);
    }
    ...
    public function screenshots_delete($slug , $key){
        ...
        return redirect()->back()->with(['success'=> 'The screenshots has been deleted']);
    }
