...
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="form-group">
                @if (check_file($other_features['other_features_image']))
                {{ Form::label('Image', __('Image'), ['class' => 'form-label']) }}
                <div class="logo-content mt-4 pb-5">
                    <img height="200px" id="image1" src="{{ get_file($other_features['other_features_image'])}}"
                        class="w-50 logo"  style="filter: drop-shadow(2px 3px 7px #011C4B);">
                </div>
                @else
                <img id="image1" width="25%" class="mt-3 mb-2">
                @endif
                <input type="file" name="other_features_image" class="form-control" onchange="document.getElementById('image1').src = window.URL.createObjectURL(this.files[0])">
            </div>
        </div>
        <div class="border" >
            <div class="row pt-3">
