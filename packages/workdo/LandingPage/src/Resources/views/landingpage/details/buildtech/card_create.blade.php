        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <input type="file" name="buildtech_card_logo" class="form-control" onchange="document.getElementById('image1').src = window.URL.createObjectURL(this.files[0])" required>
                </div>
