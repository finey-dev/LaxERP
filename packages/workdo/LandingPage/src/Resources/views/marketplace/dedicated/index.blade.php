                ...
                <div class="row">
                    ...
                    {{--  Start for all settings tab --}}
                        <div class="card">
                            ...
                            {{ Form::open(array('route' => array('dedicated_theme_header_store',$slug), 'method'=>'post', 'enctype' => "multipart/form-data" , 'class'=>'needs-validation', 'novalidate')) }}
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                                        ...
                                                        <td>
                                                            <span>
                                                                <div class="action-btn me-2">
                                                                        <a href="#" class="bg-info btn btn-sm align-items-center" data-url="{{ route('dedicated_theme_section_edit',[$slug,$key,++$no]) }}" data-ajax-popup="true" data-title="{{__('Edit Sections')}}" data-size="lg" data-bs-toggle="tooltip"  title="{{__('Edit')}}" data-original-title="{{__('Edit')}}">
