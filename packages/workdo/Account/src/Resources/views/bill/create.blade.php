...
@section('content')
    <div class="row">
        {{ Form::open(['url' => 'bill', 'class' => 'w-100 needs-validation', 'novalidate', 'enctype' => 'multipart/form-data']) }}
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            <div class="row" id="vendor-box">
                                <div class="form-group col-md-6" id="account-box">
                                    <label class="reqire form-label">{{ __('Account Type') }}</label><x-required></x-required>
                                    <select
                                        ...
                                        @endif
                                        @if (module_is_active('Taskly'))
                                            <option value="Projects" @if($type == 'project') selected @endif>{{ __('Projects') }}</option>
                                        @endif
                                    </select>
                                </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select
                                                ...
                                                <option value="product" id="product" class="d-none">{{ __('Item Wise') }}</option>
                                                <option value="project" id="project1" class="d-none">{{ __('Project Wise') }}
                                                </option>
                                            </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-icon-user">
                                            {{ Form::number('order_number', null, ['class' => 'form-control', 'required' => 'required']) }}
                                        </div>
                                    </div>
                                </div>
                                @if (module_is_active('Taskly'))
