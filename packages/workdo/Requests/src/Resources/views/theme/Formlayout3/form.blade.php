...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('packages/workdo/Requests/src/Resources/assets/form/Formlayout3/css/main-style.css') }}">
    <link rel="stylesheet" href="{{ asset('packages/workdo/Requests/src/Resources/assets/form/Formlayout3/css/responsive.css') }}">
    <style>
...
<body class="form-three {{$form->theme_color}}">
    ...
    <!--scripts start here-->
    <script src="{{ asset('packages/workdo/Requests/src/Resources/assets/form/Formlayout3/js/jquery.min.js') }}"></script>
    <script src="{{ asset('packages/workdo/Requests/src/Resources/assets/form/Formlayout3/js/custom.js') }}"></script>
    <!--scripts end here-->
