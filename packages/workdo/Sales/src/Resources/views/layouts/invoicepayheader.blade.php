...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}"
    dir="{{ company_setting('site_rtl', $company_id, $workspace) == 'on' ? 'rtl' : '' }}">
...
<head>
    ...
    {{-- @if (company_setting('site_rtl', $company_id, $workspace) == 'on') --}}
    ...
    <link rel='stylesheet' href='{{ asset('packages/workdo/Sales/src/Resources/assets/css/nprogress.css') }}' />
    <script src='{{ asset('packages/workdo/Sales/src/Resources/assets/js/nprogress.js') }}'></script>
</head>
