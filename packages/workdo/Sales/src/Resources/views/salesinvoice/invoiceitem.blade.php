{{ Form::open(array('route' => array('salesinvoice.storeitem',$invoice->id))) }}
    <div class="modal-body">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-6">
                ...
                {{ Form::number('discount',null, array('class' => 'form-control discount','required'=>'required','placeholder'=>'Enter Discount')) }}
            </div>
