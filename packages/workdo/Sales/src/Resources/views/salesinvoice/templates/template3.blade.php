...
<head>
    ...
    <title>
        ...
        |
        {{ !empty(company_setting('title_text', $invoice->created_by)) ? company_setting('title_text', $invoice->created_by, $invoice->workspace) : (!empty(admin_setting('title_text')) ? admin_setting('title_text') : 'WorkDo') }}
    </title>
    <link
