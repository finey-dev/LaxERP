...
<head>
    ...
    <title>{{ Workdo\Sales\Entities\Quote::quoteNumberFormat($quote->quote_id, $quote->created_by, $quote->workspace) }}
        |
        {{ !empty(company_setting('title_text', $quote->created_by, $quote->workspacey)) ? company_setting('title_text', $quote->created_by, $quote->workspacey) : (!empty(admin_setting('title_text')) ? admin_setting('title_text') : 'WorkDo') }}
    </title>
    <link
    ...
    <div class="invoice-preview-main" id="boxes" style="border-right:40px solid var(--theme-color);">
                ...
                <table class="no-space vertical-align-top">
                    <tbody>
                        ...
                        <tr>
                            <td>{{ __('Issue Date:') }}</td>
                            <td class="text-right">
                                {{ company_date_formate($quote->issue_date, $quote->created_by, $quote->workspace) }}</td>
                        </tr>
        ...
        <div class="invoice-body" style="padding-right: 0;">
            ...
            <div class="invoice-footer">
                <p> {{ $settings['quote_footer_title'] }}</p>
                <h6>{{ $settings['quote_footer_notes'] }}</h6>
            </div>
        </div>
    </div>
    @if (!isset($preview))
