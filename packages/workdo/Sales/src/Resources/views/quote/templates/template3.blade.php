...
<head>
    ...
    <title>{{ Workdo\Sales\Entities\Quote::quoteNumberFormat($quote->quote_id, $quote->created_by, $quote->workspace) }}
        |
        {{ !empty(company_setting('title_text', $quote->created_by)) ? company_setting('title_text', $quote->created_by, $quote->workspace) : (!empty(admin_setting('title_text')) ? admin_setting('title_text') : 'WorkDo') }}
    </title>
    <link
