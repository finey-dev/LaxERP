            ...
            <div class="row">
                ...
                <div class="col-xl-9">
                    <div id="useradd-1" class="card">
                        {{ Form::model($contact, ['route' => ['contact.update', $contact->id], 'method' => 'PUT', 'class'=>'needs-validation','novalidate','enctype' => 'multipart/form-data']) }}
                        ...
                        <div class="card-body">
                            <form>
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            <x-mobile label="Phone" name="phone" required="required"></x-mobile>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            {{ Form::label('contact_address', __('Address'), ['class' => 'form-label']) }} <x-required></x-required>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            {{ Form::label('contact_city', __('City'), ['class' => 'form-label']) }} <x-required></x-required>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            {{ Form::label('contact_state', __('State'), ['class' => 'form-label']) }} <x-required></x-required>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('stream_comment', null, ['class' => 'form-control', 'placeholder' => __('Enter Stream Information'), 'required' => 'required']) }}
                                        </div>
                                    </div>
                                ...
                                <table class="table datatable" id="datatable2">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" class="sort" data-sort="completion">
                                                {{ __('Created At') }}</th>
                                            @if (Laratrust::hasPermission('case show') || Laratrust::hasPermission('case edit') || Laratrust::hasPermission('case delete'))
                                                <th scope="col" class="text-end">{{ __('Action') }}</th>
                                            @endif
                                        </tr>
                                    </thead>
                                ...
                                <table class="table datatable" id="datatable3">
                                    <thead>
                                        <tr>
                                            ...
                                            @if (Laratrust::hasPermission('meeting show') || Laratrust::hasPermission('meeting edit') || Laratrust::hasPermission('meeting delete'))
                                                <th scope="col" class="text-end">{{ __('Action') }}</th>
                                            @endif
                                        </tr>
                                    </thead>
