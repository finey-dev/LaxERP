...
@permission('case show')
    <div class="action-btn me-2">
        <a data-size="md" data-url="{{ route('commoncases.show', $case->id) }}" data-ajax-popup="true" data-bs-toggle="tooltip"
            data-title="{{ __('Case Details') }}"title="{{ __('View') }}"
...
@permission('case edit')
    <div class="action-btn me-2">
        <a href="{{ route('commoncases.edit', $case->id) }}"
            ...
            data-title="{{ __('Edit Cases') }}"title="{{ __('Edit') }}"><i class="ti ti-pencil"></i></a>
    </div>
@endpermission
