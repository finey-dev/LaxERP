...
@php
    $path = url("packages/workdo/".$module->name."/src/marketplace");
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
            ...
            <div class="row row-gap align-items-center pdp-summery-row">
                <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                    <div class="pdp-summery">
                        ...
                        <p>{{__('Never lose a client to poor sales management ever again! Easily manage your sales, Calls, Documents, quotes, meeting schedule, Opportunities, and orders from one intuitive dashboard.')}}</p>
                        <div class="price">
                            <ins><span class="currency-type">{{super_currency_format_with_sym($module->monthly_price)}}</span><span class="time-lbl">{{__('/Month')}}</span></ins>
                            <ins><span class="currency-type">{{super_currency_format_with_sym($module->yearly_price)}}</span><span class="time-lbl">{{__('/Year')}}</span></ins>
                        </div>
    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="section-title text-center">
                <h2>{{__('Sales Makes It Super Easy For You To Manage Your Sales')}}</h2>
                <p>{{__('You can also find the individual overview of each of these elements broken down in percentages with their respective status.  Additionally, know the top due tasks, meeting schedule, and monthly calls on this dashboard.')}}</p>
            </div>
            <div class="row row-gap padding-bottom ">
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            <h2>{{__('The Smartest Way To Manage Your Sales')}}</h2>
                        </div>
                        <p>{{__('Sales monitor your sales performance like a coach and let you know whether you are on track. Get real-time reports about every sales activity you make, make smarter decisions, and manage your business’s general sales more efficiently.')}} </p>
                        <div class="theme-acnav">
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Manage All Your Sales From One Place')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Manage every aspect of your business sales from one place. Get sales updates on a daily, weekly, or monthly basis. Monitor your sales and accounts from a single comprehensive dashboard.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Manage Your Sales Order Easily')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Get an overview of all your quotes, sales orders, and invoices. Know who ordered what and easily monitor order fulfillment. Get vital information like status, account, assigned user, created date, etc. in one single list or grid.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
            ...
            <div class="row row-gap  padding-bottom">
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            <h2>{{__('Modify Vital Sales Info With Ease')}}</h2>
                        </div>
                        <p>{{__('Access a wide range of easily customizable features in one place. Get an overview of your sales invoices, quotes, and sales order- all under one roof.')}}</p>
                        <div class="theme-acnav">
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    <span class="acnav-icon">
                                    ...
                                    <span>{{__('Convert Quotes to Sales Order')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Modify and update your generated sales quotes with ease. Convert your quotes to sales orders, get accurate information, and add new orders and products without stress.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Manage Your Payments Easily')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Get paid for work done, fast. Integrate several payment options for diverse clients and make the payment process stress-free. Easily safeguard your clients’ payments by using Stripe, PayPal, Flutterwave, and more.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Sales Invoice Report Management')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('In the sales invoice, you can view the monthly report and in the sales invoice. You can also view the assigned accountant status-wise.')}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row row-gap align-items-center padding-bottom">
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            <h2>{{__('Sales Order Report Manage')}}</h2>
                        </div>
                        <p>{{__('Get tailored analytics and reports sent to you automatically. Get an in-depth analysis of sales orders, sales invoices, and quotes. Easily filter through these reports by setting various parameters. Get status, amount, assigned users, created date, and other important information in a single list. Easily print sales orders, and invoices and add new items to existing orders.')}}</p>
                    </div>
                </div>
                <div class="col-lg-7 col-md-6 col-12">
                    <div class="dash-theme-preview">
            ...
            <div class="row row-gap align-items-center padding-bottom">
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            <h2>{{__('Continuous Improvement and Adaptation')}}</h2>
                        </div>
                        <p>{{__('Our sales management platform is not static; its designed for continuous improvement and adaptation. We regularly update our features based on user feedback and industry trends, ensuring that you always have access to the latest tools and technologies to stay ahead of the competition. With our commitment to innovation, you can trust that your sales processes will evolve alongside your business needs, driving sustainable growth and success.')}}</p>
                    </div>
                </div>
                <div class="col-lg-7 col-md-6 col-12">
                    <div class="dash-theme-preview">
                            ...
                            <div class="tabs-container">
                                <div class="tab-content active" id="tab-1">
                                    <div class="pricing-content">
                                        <div class="price">
                                            <ins><span class="currency-type"></span>{{super_currency_format_with_sym($module->monthly_price)}}<span
                                                    class="time-lbl">{{__('/Month')}}</span></ins>
                                        </div>
                                        <div class="lbl">{{__('Billed month, or')}} <b>{{super_currency_format_with_sym($module->monthly_price)}}{{__('/mo')}}</b>{{__(' if paid month')}}</div>
                                        <div class="btn-group">
                                ...
                                <div class="tab-content" id="tab-2">
                                    <div class="pricing-content">
                                        <div class="price">
                                            <ins><span class="currency-type"></span>{{ super_currency_format_with_sym($module->yearly_price) }}<span
                                                    class="time-lbl">{{('/yearly')}}</span></ins>
                                        </div>
                                        <div class="lbl">{{__('Billed year, or ')}}<b>{{ super_currency_format_with_sym($module->yearly_price) }}{{__('/mo')}}</b>{{__('if paid year')}}</div>
                                        <div class="btn-group">
                                            <a href="{{ route('apps.pricing') }}" class="btn-secondary">{{__('Buy Now')}}<svg
                                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    viewBox="0 0 16 16" fill="none">
    ...
    <section class="screenshot-section padding-top padding-bottom">
        <div class="container">
            <div class="screenshot-slider">
                ...
                <div class="screenshot-itm">
                    <div class="screenshot-image">
                        <a href="{{ $path . '/image7.png' }}" target="_blank" class="img-zoom">
                            <img src="{{ $path . '/image7.png' }}" alt="">
                        </a>
                    </div>
                </div>
                <div class="screenshot-itm">
                        ...
                        <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 col-12 product-card">
                            <div class="product-card-inner">
                                ...
                                <div class="product-content">
                                    <h4> <a href="{{ route('software.details', $module->alias) }}">{{ $module->alias }}</a> </h4>
                                    <div class="price">
