...
@php
    $path = url('/packages/workdo/CourierManagement/src/marketplace');
        ...
        <section class="dedicated-themes-section padding-bottom">
            <div class="container">
                <div class="section-title text-center">
                    <h2>{{ __('Efficient ') }}<b>{{ __('Dispatch Solutions ') }}</b>{{ __('The Essence of Courier Management') }}
                    </h2>
                    <p>{{ __('Seamlessly orchestrating order fulfillment, route optimization, and real-time tracking, our system ensures a streamlined workflow, minimizing delays and maximizing customer satisfaction.') }}
                    </p>
                </div>
