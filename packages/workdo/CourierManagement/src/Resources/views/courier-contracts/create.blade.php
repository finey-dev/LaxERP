{{ Form::open(['route' => 'courier-contracts.store', 'class' => 'needs-validation', 'novalidate']) }}
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-6">
                ...
                {{ Form::select('status', ['' => __('Select Status'), 1 => __('Active'), 0 => __('Expired')], null, ['class' => 'form-control select', 'required' => 'required']) }}
                @error('status')
