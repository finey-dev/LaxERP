{{ Form::open(['url' => 'planningchallenges','enctype' => 'multipart/form-data', 'class' => 'needs-validation', 'novalidate']) }}
<div class="modal-body">
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                {{Form::label('challenge_name',__('Challenge Name'),['class'=>'form-label']) }}<x-required></x-required>
                {{Form::text('challenge_name',null,array('class'=>'form-control','placeholder'=>__('Enter Challenge Name'),'required'=>'required'))}}
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
        ...
        <div class="form-group col-md-6">
            ...
            <input class="form-control" value="{{ date('Y-m-d h:i') }}" placeholder="{{ __('Select Date/Time') }}"
                required="required" name="end_date" type="datetime-local">
        </div>
        <div class="col-md-6">
            <div class="form-group">
