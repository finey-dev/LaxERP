...
@section('content')
    <div class="row">
        <div class="col-sm-12">
            {{ Form::open(['route' => ['planningcharters.store'], 'method' => 'post', 'enctype' => 'multipart/form-data', 'class' => 'needs-validation', 'novalidate']) }}
            <div class="row">
                <div class="col-md-6">
                    <div class="card em-card">
                        <div class="card-header">
                            <h6 class="mb-0">{{ __('Add Planning Charter') }}</h6>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <textarea class="form-control summernote" name="description" id="exampleFormControlTextarea1" rows="3" required></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea class="form-control summernote {{ !empty($errors->first('organisational_effects')) ? 'is-invalid' : '' }}"
                                        name="organisational_effects" id="exampleFormControlTextarea2" rows="3"></textarea>

                                </div>
                                <div class="form-group col-md-12">
                                    {{ Form::label('goal_description', __('Goal Description '), ['class' => 'form-label']) }}
                                    <textarea class="form-control summernote {{ !empty($errors->first('goal_description')) ? 'is-invalid' : '' }}"
                                        name="goal_description" id="exampleFormControlTextarea3" rows="3"></textarea>
                                </div>
                                <div class="form-group col-md-12">
                                    {{ Form::label('notes', __('Notes '), ['class' => 'form-label']) }}
                                    <textarea class="form-control summernote {{ !empty($errors->first('notes')) ? 'is-invalid' : '' }}" name="notes"
                                        id="exampleFormControlTextare4" rows="3"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                <input type="button" value="{{ __('Cancel') }}" onclick="location.href = '{{ route('planningcharters.index') }}';"
