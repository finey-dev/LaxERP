{{ Form::model($visitorLog,['route'=>['visitor-log.update',$visitorLog->id],'class'=>'needs-validation','novalidate','method' =>'PUT']) }}
    <div class="modal-body">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-6">
                ...
                {{Form::select('visit_reason',$visitReason,$visitorLog->getVisitReason(),array('class'=>'form-control font-style','required'=>'required'))}}
            </div>
            <div class="form-group col-md-6">
...
{{ Form::close() }}
<script>
    $('select[name=visitor_id]').trigger('change');
</script>
