...
@php
    $path = url('packages/workdo/VisitorManagement/src/marketplace');
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
                ...
                <div class="row row-gap align-items-center pdp-summery-row">
                    <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                        <div class="pdp-summery">
                            ...
                            <p>{{ __('Are you looking for an efficient, comprehensive, and reliable solution to manage visitor check-ins, check-outs, and activity tracking within your premises? Our Visitor Management System module is the perfect solution for your needs!') }}
                            </p>
                            <div class="price">
                                <ins><span
        ...
        <section class="dedicated-themes-section padding-bottom">
            <div class="container">
                <div class="section-title text-center">
                    <h2>{{ __('Check-In') }}<b>{{ __('/') }}</b>{{ __('Check-Out') }}</h2>
                    <p>{{ __('Visitors can check in and out using this system, recording their entry and exit times along with the purpose of their visit.') }}
                    </p>
                </div>
                            ...
                            <div class="theme-acnav">
                                <div class="set has-children">
                                    <a href="javascript:;" class="acnav-label">
                                        ...
                                        <span>{{ __('Real-time Updates') }}</span>
                                    </a>
                                    <div class="acnav-list">
                                        <p>{{ __('The system updates the timeline in real-time, reflecting changes as visitors check in or out.') }}
                                        </p>
                                    </div>
                                </div>
                                <div class="set has-children">
                                    <a href="javascript:;" class="acnav-label">
                                        ...
                                        <span>{{ __('Security and Access Control') }}</span>
                                    </a>
                                    <div class="acnav-list">
                                        <p>{{ __('Helps in managing security by providing insights into who is currently present on-site and ensuring only authorized individuals are allowed access.') }}
                                        </p>
                                    </div>
                                </div>
                                <div class="set has-children">
                                    <a href="javascript:;" class="acnav-label">
                                        ...
                                        <span>{{ __('Analytics and Reporting') }}</span>
                                    </a>
                                    <div class="acnav-list">
                                        <p>{{ __('The system can generate reports and analytics based on visitor data, helping in analyzing trends, peak visiting hours, or common purposes of visits.') }}
                                        </p>
                                    </div>
                                </div>
                            </div>
