{{ Form::open(['route'=>['visitors-badge.store'],'class'=>'needs-validation','novalidate','method' =>'POST']) }}
    <div class="modal-body">
        ...
        <div class="form-group col-md-6">
            ...
            <div class="form-group col-md-6">
                ...
                {{Form::datetimeLocal('issue_date',null,array('class'=>'form-control visitor-data font-style','required'=>'required'))}}
            </div>
            <div class="form-group col-md-6">
