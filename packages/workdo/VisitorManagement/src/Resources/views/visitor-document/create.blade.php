{{ Form::open(['route' => ['visitors-documents.store'], 'class' => 'needs-validation', 'novalidate', 'method' => 'POST']) }}
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-6">
            {{ Form::label('document_type', __('Document Type'), ['class' => 'form-label']) }}<x-required></x-required>
            {{ Form::select('document_type', $document, null, ['class' => 'form-control font-style', 'required' => 'required']) }}
        </div>
        <div class="form-group col-md-6">
