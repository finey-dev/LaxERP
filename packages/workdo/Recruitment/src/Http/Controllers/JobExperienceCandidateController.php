...
use Workdo\Recruitment\Events\CreateJobExperienceCandidate;
use Workdo\Recruitment\Events\DestroyJobExperienceCandidate;
use Workdo\Recruitment\Events\UpdateJobExperienceCandidate;
...
class JobExperienceCandidateController extends Controller
{
    ...
    public function store(Request $request)
    {
        if (Auth::user()->isAbleTo('experience candidate job create')) {
            ...
            return redirect()->back()->with('success', __('The experience candidate job has been created successfully.'))->with('experience-tab', true);
        } else {
    ...
    public function update(Request $request, JobExperienceCandidate $job_experience_candidate)
    {
        if (Auth::user()->isAbleTo('experience candidate job edit')) {
            ...
            return redirect()->back()->with('success', __('The experience candidate job details are updated successfully.'))->with('experience-tab', true);
        } else {
            return redirect()->back()->with('error', __('Permission denied.'));
        }
    }
    ...
    public function destroy($id)
    {
        if (Auth::user()->isAbleTo('experience candidate job delete')) {
            ...
            return redirect()->back()->with('success', __('The experience candidate job has been deleted.'))->with('experience-tab', true);
        } else {
            return redirect()->back()->with('error', __('Permission denied.'));
        }
    }
