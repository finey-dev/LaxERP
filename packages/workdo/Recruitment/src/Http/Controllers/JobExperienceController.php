...
use Workdo\Recruitment\Events\CreateJobExperience;
use Workdo\Recruitment\Events\DestroyJobExperience;
use Workdo\Recruitment\Events\UpdateJobExperience;
...
class JobExperienceController extends Controller
{
    ...
    public function store(Request $request)
    {
        if (Auth::user()->isAbleTo('job experience create')) {
            ...
            return redirect()->back()->with('success', __('The job experience has been created successfully.'))->with('experience-tab', true);
        } else {
    ...
    public function update(Request $request, $id)
    {
        if (Auth::user()->isAbleTo('job experience edit')) {
            ...
            return redirect()->back()->with('success', __('The job experience details are updated successfully.'))->with('experience-tab', true);
        } else {
            return redirect()->back()->with('error', __('Permission denied.'));
        }
    }
    ...
    public function destroy($id)
    {
        if (Auth::user()->isAbleTo('job experience delete')) {
            ...
            if ($job_experience->created_by == creatorId() && $job_experience->workspace == $currentWorkspace) {
                ...
                return redirect()->back()->with('success', __('The job experience has been deleted.'))->with('experience-tab', true);
            } else {
