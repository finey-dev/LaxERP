...
use Workdo\Recruitment\Events\CreateJobAward;
use Workdo\Recruitment\Events\DestroyJobAward;
use Workdo\Recruitment\Events\UpdateJobAward;
...
class JobAwardController extends Controller
{
    ...
    public function store(Request $request)
    {
        if (Auth::user()->isAbleTo('job award create')) {
            ...
            return redirect()->back()->with('success', __('The job award has been created successfully.'))->with('experience-tab', true);
        } else {
    ...
    public function update(Request $request, JobAward $job_award)
    {
        if (Auth::user()->isAbleTo('job award edit')) {
            ...
            return redirect()->back()->with('success', __('The job award details are updated successfully.'))->with('experience-tab', true);
        } else {
            return redirect()->back()->with('error', __('Permission denied.'));
        }
    }
    ...
    public function destroy($id)
    {
        if (Auth::user()->isAbleTo('job award delete')) {
            ...
            return redirect()->back()->with('success', __('The job award has been deleted.'))->with('experience-tab', true);
        } else {
            return redirect()->back()->with('error', __('Permission denied.'));
        }
    }
