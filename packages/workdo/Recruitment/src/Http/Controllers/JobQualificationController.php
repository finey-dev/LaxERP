...
use Workdo\Recruitment\Events\CreateJobQualification;
use Workdo\Recruitment\Events\DestroyJobQualification;
use Workdo\Recruitment\Events\UpdateJobQualification;
...
class JobQualificationController extends Controller
{
    ...
    public function store(Request $request)
    {
        if (Auth::user()->isAbleTo('job qualification create')) {
            ...
            return redirect()->back()->with('success', __('The job qualification has been created successfully.'))->with('experience-tab', true);
        } else {
    ...
    public function update(Request $request, JobQualification $job_qualification)
    {
        if (Auth::user()->isAbleTo('job qualification edit')) {
            ...
            return redirect()->back()->with('success', __('The job qualification details are updated successfully.'))->with('experience-tab', true);
        } else {
            return redirect()->back()->with('error', __('Permission denied.'));
        }
    }
    ...
    public function destroy($id)
    {
        if (Auth::user()->isAbleTo('job qualification delete')) {
            ...
            return redirect()->back()->with('success', __('The job qualification has been deleted.'))->with('experience-tab', true);
        } else {
