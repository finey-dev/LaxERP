...
use Workdo\Recruitment\Events\CreateJobProject;
use Workdo\Recruitment\Events\DestroyJobProject;
use Workdo\Recruitment\Events\UpdateJobProject;
...
class JobProjectController extends Controller
{
    ...
    public function store(Request $request)
    {
        if (Auth::user()->isAbleTo('job project create')) {
            ...
            return redirect()->back()->with('success', __('The job project has been created successfully.'))->with('experience-tab', true);
        } else {
    ...
    public function update(Request $request, JobProject $job_project)
    {
        if (Auth::user()->isAbleTo('job project edit')) {
            ...
            return redirect()->back()->with('success', __('The job project details are updated successfully.'))->with('experience-tab', true);
        } else {
            return redirect()->back()->with('error', __('Permission denied.'));
        }
    }
    ...
    public function destroy($id)
    {
        if (Auth::user()->isAbleTo('job project delete')) {
            ...
            return redirect()->back()->with('success', __('The job project has been deleted.'))->with('experience-tab', true);
        } else {
