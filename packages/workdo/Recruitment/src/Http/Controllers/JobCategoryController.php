...
class JobCategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        if (Auth::user()->isAbleTo('jobcategory create')) {
            ...
            return redirect()->back()->with('success', __('The job category has been created successfully.'));
        } else {
            return redirect()->back()->with('error', __('Permission denied.'));
        }
    }
    ...
    public function update(JobCategory $jobCategory, Request $request)
    {
        if (Auth::user()->isAbleTo('jobcategory edit')) {
            ...
            return redirect()->back()->with('success', __('The job category details are updated successfully.'));
        } else {
            return redirect()->back()->with('error', __('Permission denied.'));
        }
    }
