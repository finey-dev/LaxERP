...
use Workdo\Recruitment\Events\CreateJobSkill;
use Workdo\Recruitment\Events\DestroyJobSkill;
use Workdo\Recruitment\Events\UpdateJobSkill;
...
class JobSkillController extends Controller
{
    ...
    public function store(Request $request)
    {
        if (Auth::user()->isAbleTo('job skill create')) {
            ...
            return redirect()->back()->with('success', __('The job skill has been created successfully.'))->with('experience-tab', true);
        } else {
    ...
    public function update(Request $request, JobSkill $job_skill)
    {
        if (Auth::user()->isAbleTo('job skill edit')) {
            ...
            return redirect()->back()->with('success', __('The job skill details are updated successfully.'))->with('experience-tab', true);
        } else {
            return redirect()->back()->with('error', __('Permission denied.'));
        }
    }
    ...
    public function destroy($id)
    {
        if (Auth::user()->isAbleTo('job skill delete')) {
            ...
            return redirect()->back()->with('success', __('The job skill has been deleted.'))->with('experience-tab', true);
        } else {
            return redirect()->back()->with('error', __('Permission denied.'));
        }
    }
