...
class OfferLetter extends Model
{
    ...
    {
        return \Workdo\Recruitment\Database\factories\OfferLetterFactory::new();
    }
    ...
    public static function defaultOfferLetter($company_id = null, $workspace_id = null)
    {
        $defaultTemplate = [
        ...
        foreach ($defaultTemplate as $lang => $content) {
            $offerletter = OfferLetter::where('lang', $lang)->where('workspace', $workspace_id)->where('created_by', $company_id)->first();
