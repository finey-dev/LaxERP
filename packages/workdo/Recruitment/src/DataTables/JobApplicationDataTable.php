...
class UsersDataTable extends DataTable
{
    ...
    {
        $applications = $model->where('created_by', creatorId())->where('workspace', getActiveWorkSpace());
    ...
    public function html(): HtmlBuilder
    {
        $dataTable = $this->builder()
            ->setTableId('job-application-table')
    ...
    {
        return 'Job Application_' . date('YmdHis');
    }
}
