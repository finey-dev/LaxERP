{{ Form::model($jobcandidate_referral, ['route' => ['jobcandidate-referral.update', $jobcandidate_referral->id], 'method' => 'PUT', 'enctype' => 'multipart/form-data', 'class' => 'needs-validation', 'novalidate']) }}
    ...
    <div class="row">
            ...
            <div class="choose-file form-group">
                <label for="experience_proof" class="form-label d-block">
                    ...
                    <div class="mt-1">
                        ...
                        src="@if ($jobcandidate_referral->experience_proof) {{ get_file($jobcandidate_referral->experience_proof) }} @endif" />
                    </div>
                </label>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <textarea class="tox-target summernote" id="description2" name="description" rows="8">{!! $jobcandidate_referral->description !!}</textarea>
            </div>
        </div>
    </div>
</div>
...
<script>
    $(document).ready(function() {
        // Function to show/hide reference fields
        ...
        $('#reference').on('change', toggleReferenceFields);
    });
</script>
