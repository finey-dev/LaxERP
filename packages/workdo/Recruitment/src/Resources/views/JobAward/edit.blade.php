{{ Form::model($job_award, ['route' => ['job-award.update', $job_award->id], 'method' => 'PUT', 'class' => 'needs-validation', 'novalidate']) }}
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <textarea class="tox-target summernote" id="description6" name="description" rows="8">{!! $job_award->description !!}</textarea>
            </div>
        </div>
    </div>
</div>
