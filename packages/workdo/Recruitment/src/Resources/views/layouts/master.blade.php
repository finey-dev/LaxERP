...
<head>
    ...
    <link rel="icon"
        href="{{ !empty($company_settings['favicon']) ? $company_settings['favicon'] : (!empty($admin_settings['favicon']) ? $admin_settings['favicon'] : get_file('uploads/logo/favicon.png')) }}"
        type="image/x-icon" />
    ...
    <!-- font css -->
    <link rel="stylesheet" href="{{ asset('packages/workdo/Recruitment/src/Resources/assets/css/site.css') }}"
        id="stylesheet">
    ...
    @if (isset($company_settings['cust_darklayout']) && $company_settings['cust_darklayout'] == 'on')
        ...
        <link rel="stylesheet"
            href="{{ asset('packages/workdo/Recruitment/src/Resources/assets/css/custom-dark.css') }}">
    @else
        <link rel="stylesheet" href="{{ asset('assets/css/style.css') }}" id="main-style-link">
    @endif

    <script src="{{ asset('js/jquery.min.js') }}"></script>
    <link rel="stylesheet" href="{{ asset('packages/workdo/Recruitment/src/Resources/assets/css/nprogress.css') }}">
    ...
    <script src="{{ asset('packages/workdo/Recruitment/src/Resources/assets/js/nprogress.js') }}"></script>
</head>
