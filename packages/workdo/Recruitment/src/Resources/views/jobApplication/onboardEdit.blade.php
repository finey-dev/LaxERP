...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            {!! Form::text('days_of_week', null, ['class' => 'form-control ', 'autocomplete' => 'off' , 'placeholder' => __('Enter Days Of Week')]) !!}
        </div>
        <div class="form-group col-md-6">
            {!! Form::label('salary', __('Salary'), ['class' => 'form-label']) !!}
            {!! Form::text('salary', null, ['class' => 'form-control ', 'autocomplete' => 'off' , 'placeholder' => __('Enter Salary')]) !!}
        </div>
        <div class="form-group col-md-6">
        ...
        <div class="form-group col-md-6">
            {{ Form::label('salary_duration', __('Salary Type'), ['class' => 'form-label']) }}
