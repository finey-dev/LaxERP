...
<div>
    @permission('jobstage create')
        <a  data-url="{{ route('job-stage.create') }}" data-ajax-popup="true"
            data-title="{{ __('Create Job Stage') }}" data-bs-toggle="tooltip" title="" class="btn btn-sm btn-primary"
...
@push('scripts')
    <script src="{{ asset('packages/workdo/Recruitment/src/Resources/assets/js/jquery-ui.min.js') }}"></script>
