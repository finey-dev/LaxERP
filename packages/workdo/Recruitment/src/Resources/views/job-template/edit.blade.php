...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            const customLinkUrl = "{{ $job_template->job_link }}";
            ...
            function toggleJobLinkInput() {
                if ($('#existing_link').is(':checked')) {
                    ...
                    if (customLinkUrl != null) {
                        $('input[name="job_link"]').val(customLinkUrl).prop('disabled', false);
...
@section('content')
    <div class="row">
        {{ Form::model($job_template, ['route' => ['job-template.update', $job_template->id], 'method' => 'PUT', 'class' => 'needs-validation', 'novalidate']) }}
        <div class="card">
            <div class="card-body">
                <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea name="address" class="form-control {{ !empty($errors->first('address')) ? 'is-invalid' : '' }}"
                                            id="address" rows="4">{{ $job_template->address }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <div class="d-flex radio-check">
                                            <div class="form-check form-check-inline form-group">
                                                <input type="radio" id="existing_link" value="Existing Link"
                                                    name="link_type" class="form-check-input" checked>
                                                <label class="form-check-label" for="existing_link"
                                                    {{ isset($job_template->link_type) && $job_template->link_type == 'Existing Link' ? 'checked' : '' }}>{{ __('Existing link') }}</label>
                                            </div>
                                            <div class="form-check form-check-inline form-group">
                                                <input type="radio" id="custom_link" value="Custom Link" name="link_type"
                                                    class="form-check-input"
                                                    {{ isset($job_template->link_type) && $job_template->link_type == 'Custom Link' ? 'checked' : '' }}>
                                                <label class="form-check-label"
                                                    for="custom_link">{{ __('Custom Link') }}</label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-12">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control" value="{{ $job_template->skill }}"
                                            ...
                                            <div class="my-4">
                                                <div class="form-check custom-checkbox">
                                                    <input type="checkbox" class="form-check-input" name="applicant[]"
                                                        ...
                                                        {{ in_array('gender', $job_template->applicant) ? 'checked' : '' }}>
                                                    <label class="form-check-label"
                                                ...
                                                <div class="form-check custom-checkbox">
                                                    <input type="checkbox" class="form-check-input" name="applicant[]"
                                                        ...
                                                        {{ in_array('dob', $job_template->applicant) ? 'checked' : '' }}>
                                                    <label class="form-check-label"
                                                ...
                                                <div class="form-check custom-checkbox">
                                                    <input type="checkbox" class="form-check-input" name="applicant[]"
                                                        ...
                                                        {{ in_array('country', $job_template->applicant) ? 'checked' : '' }}>
                                                    <label class="form-check-label"
                                            ...
                                            <div class="my-4">
                                                <div class="form-check custom-checkbox">
                                                    <input type="checkbox" class="form-check-input" name="visibility[]"
                                                        ...
                                                        {{ in_array('profile', $job_template->visibility) ? 'checked' : '' }}>
                                                    <label class="form-check-label"
                                                ...
                                                <div class="form-check custom-checkbox">
                                                    <input type="checkbox" class="form-check-input" name="visibility[]"
                                                        ...
                                                        {{ in_array('resume', $job_template->visibility) ? 'checked' : '' }}>
                                                    <label class="form-check-label"
                                                ...
                                                <div class="form-check custom-checkbox">
                                                    <input type="checkbox" class="form-check-input" name="visibility[]"
                                                        ...
                                                        {{ in_array('letter', $job_template->visibility) ? 'checked' : '' }}>
                                                    <label class="form-check-label"
                                                ...
                                                <div class="form-check custom-checkbox">
                                                    <input type="checkbox" class="form-check-input" name="visibility[]"
                                                        ...
                                                        {{ in_array('terms', $job_template->visibility) ? 'checked' : '' }}>
                                                    <label class="form-check-label"
                                        ...
                                        @foreach ($customQuestion as $question)
                                            <div class="form-check custom-checkbox">
                                                <input type="checkbox" class="form-check-input" name="custom_question[]"
                                                    ...
                                                    {{ in_array($question->id, $job_template->custom_question) ? 'checked' : '' }}>
                                                <label class="form-check-label"
                    ...
                    <div class="tab-pane fade" id="descriptions-tab" role="tabpanel" aria-labelledby="pills-user-tab-2">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea name="description"
                                        ...
                                        id="description">{{ $job_template->description }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea name="requirement"
                                        ...
                                        id="requirement">{{ $job_template->requirement }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-12" id="termsandcondition">
                                <div class="form-group terms_val col-md-12">
                                    ...
                                    <textarea name="terms_and_conditions"
                                        ...
                                        id="terms_and_conditions">{{ $job_template->terms_and_conditions }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="mt-3 row">
                            ...
                            <div class="col-6 text-end" id="savebutton">
                                <a class="btn btn-secondary btn-submit"
                                    href="{{ route('job-template.index') }}">{{ __('Cancel') }}</a>
