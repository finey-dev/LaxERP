...
@php
    $path = url('packages/workdo/Recruitment/src/marketplace');
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
        ...
        <section class="dedicated-themes-section padding-bottom">
            <div class="container">
                <div class="section-title text-center">
                    <h2>{{ __('Recruit New ') }}<b>{{ __('Candidates') }}</b>{{ __(' and Grow Your Team') }}</h2>
                    <p>{{ __('Collect and manage applications from start to finish. Easily compare candidates and pick the best one for
                                                        the job.') }}
                    </p>
                </div>
                            ...
                            <div class="theme-acnav">
                                <div class="set has-children">
                                    <a href="javascript:;" class="acnav-label">
                                        ...
                                        <span>{{ __('Job Links') }}</span>
                                    </a>
                                    <div class="acnav-list">
                                        <p>{{ __('The Recruitment module allows users to easily add links to job applications, whether using an existing URL or generating a custom link. These links can be shared directly with candidates or embedded on external platforms to drive traffic to specific job postings. This streamlined functionality ensures maximum visibility and accessibility for job applications, helping recruiters connect with a wider pool of qualified applicants.') }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row row-gap align-items-center padding-bottom">
                    ...
                    <div class="col-lg-5 col-md-6 col-12">
                        <div class="abt-theme">
                            <div class="section-title">
                                <h2>{{ __('Candidate Management') }}</h2>
                            </div>
                            <p>{{ __('Efficiently managing incoming job applications is facilitated through the Candidate Management page. Here, users can review, filter, and respond to applications seamlessly. This centralized hub provides a clear overview of each candidates journey, from onboarding application. Robust filtering and sorting options allow users to prioritize candidates based on qualifications and suitability for the role.') }}
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row row-gap align-items-center padding-bottom">
                    ...
                    <div class="col-lg-5 col-md-6 col-12">
                        <div class="abt-theme">
                            <div class="section-title">
                                <h2>{{ __('Career Page') }}</h2>
                            </div>
                            <p>{{ __('The Career Page is a gateway for potential candidates to learn more about the organization, culture, and available opportunities. Here, users can showcase company values, employee testimonials, career growth prospects, and upcoming events. With engaging multimedia content and informative resources, the Career Page effectively communicates the employer value proposition and stands out in a competitive job market, attracting top talent and fostering a strong employer brand.') }}
                            </p>
                        </div>
                    </div>
                </div>
                <div class="row row-gap align-items-center ">
                    <div class="col-lg-5 col-md-6 col-12">
                        <div class="abt-theme">
                            ...
                            <p> {{ __('In the Recruitment module, users can view comprehensive job details, including descriptions, questions, applications, attachments, notes, to-do lists, and activity logs. This feature ensures all relevant information is accessible in one place, streamlining the job posting process and allowing for better organization and management of each job listing.') }}
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-7 col-md-6 col-12">
                    ...
                    <div class="row row-gap">
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="section-title">
                                ...
                                <p>{{ __('Access over Premium Add-ons for Accounting, HR, Payments, Leads, Communication, Management, and more, all in one place!') }}
                                </p>
                                        ...
                                        <div class="pricing-content">
                                            ...
                                            <div class="btn-group">
                                                <a href="{{ route('apps.pricing') }}"
                                                    class="btn-secondary">{{ __('Buy Now') }} <svg
        ...
        <section class="screenshot-section padding-top padding-bottom">
            <div class="container">
                ...
                <div class="screenshot-slider">
                    ...
                    <div class="screenshot-itm">
                        <div class="screenshot-image">
                            <a href="{{ $path . '/image8.png' }}" target="_blank" class="img-zoom">
                                <img src="{{ $path . '/image8.png' }}" alt="">
                            </a>
                        </div>
                    </div>
                    <div class="screenshot-itm">
                        <div class="screenshot-image">
                            <a href="{{ $path . '/image9.png' }}" target="_blank" class="img-zoom">
                                <img src="{{ $path . '/image9.png' }}" alt="">
                            </a>
                        </div>
                    </div>
                    <div class="screenshot-itm">
                        <div class="screenshot-image">
                            <a href="{{ $path . '/image10.png' }}" target="_blank" class="img-zoom">
                                <img src="{{ $path . '/image10.png' }}" alt="">
                            </a>
                        </div>
                    </div>
                    <div class="screenshot-itm">
                        <div class="screenshot-image">
                            <a href="{{ $path . '/image11.png' }}" target="_blank" class="img-zoom">
                                <img src="{{ $path . '/image11.png' }}" alt="">
                            </a>
                        </div>
                    </div>
                    <div class="screenshot-itm">
                        <div class="screenshot-image">
                            <a href="{{ $path . '/image12.png' }}" target="_blank" class="img-zoom">
                                <img src="{{ $path . '/image12.png' }}" alt="">
                            </a>
                        </div>
                    </div>
                    <div class="screenshot-itm">
                        <div class="screenshot-image">
                            <a href="{{ $path . '/image13.png' }}" target="_blank" class="img-zoom">
                                <img src="{{ $path . '/image13.png' }}" alt="">
                            </a>
                        </div>
                    </div>
                </div>
