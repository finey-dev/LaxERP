{{ Form::open(['route' => 'job-skill.store', 'method' => 'post', 'class' => 'needs-validation', 'novalidate']) }}
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <textarea class="tox-target summernote" id="description5" name="description" rows="8"></textarea>
            </div>
        </div>
    </div>
</div>
