{{ Form::model($job_skill, ['route' => ['job-skill.update', $job_skill->id], 'method' => 'PUT', 'class' => 'needs-validation', 'novalidate']) }}
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <textarea class="tox-target summernote" id="description5" name="description" rows="8">{!! $job_skill->description !!}</textarea>
            </div>
        </div>
    </div>
</div>
