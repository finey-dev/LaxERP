{{ Form::model($job_project, ['route' => ['job-project.update', $job_project->id], 'method' => 'PUT', 'class' => 'needs-validation', 'novalidate']) }}
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <textarea class="tox-target summernote" id="description2" name="description" rows="8">{!! $job_project->description !!}</textarea>
            </div>
        </div>
    </div>
</div>
