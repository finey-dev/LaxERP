                                        ...
                                        <div class="card mb-3 border shadow-none">
                                            <div class="px-3">
                                                <div class="row align-items-center">
                                                    <div class="col ml-n2  mb-0 fc-event-title-container">
                                                    ...
                                                    <div class="col-auto text-right">
                                                        <div class="mb-4">
                                                            @permission('interview schedule show')
                                                                <div class="action-btn  me-2">
                                                                    <a class="mx-3 btn btn-sm  align-items-center bg-warning"
                                                                        data-url="{{ route('interview-schedule.show', $schedule->id) }}"
                                                                        data-ajax-popup="true" data-title="{{ !empty($schedule->applications) ? (!empty($schedule->applications->jobs) ? $schedule->applications->jobs->title : '') : '' }}"
