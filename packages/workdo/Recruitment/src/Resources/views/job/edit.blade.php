                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea name="address" class="form-control {{ !empty($errors->first('address')) ? 'is-invalid' : '' }}" placeholder="{{__('Enter Address')}}"
                                            id="address" rows="3">{{ $job->address }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <div class="d-flex radio-check">
                                            <div class="form-check form-check-inline form-group">
                                                ...
                                                <label class="form-check-label" for="existing_link" {{ isset($job->link_type) && $job->link_type == 'Existing Link' ? 'checked' : '' }}>{{ __('Existing link') }}</label>
                                            </div>
                                            <div class="form-check form-check-inline form-group">
                                                <input type="radio" id="custom_link" value="Custom Link" name="link_type" class="form-check-input" {{ isset($job->link_type) && $job->link_type == 'Custom Link' ? 'checked' : '' }}>
...
<script>
    $(document).ready(function () {
        ...
        const customLinkUrl = "{{ $job->job_link }}";
