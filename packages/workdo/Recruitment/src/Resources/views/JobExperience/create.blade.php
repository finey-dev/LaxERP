{{ Form::open(['route' => 'job-experience.store', 'method' => 'post', 'enctype' => 'multipart/form-data', 'class' => 'needs-validation', 'novalidate']) }}
...
<div class="modal-body">
    <div class="row">
        ...
        <x-mobile divClass="col-md-6 reference_div d-none" name="reference_phone" label="{{ __('Reference Phone') }}"
            placeholder="{{ __('Enter Reference Phone Number') }}" id="reference_phone" required>
        </x-mobile>
        <div class="col-md-6 reference_div d-none">
            <div class="form-group">
