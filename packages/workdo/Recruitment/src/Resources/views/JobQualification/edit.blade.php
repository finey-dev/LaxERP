{{ Form::model($job_qualification, ['route' => ['job-qualification.update', $job_qualification->id], 'method' => 'PUT', 'class' => 'needs-validation', 'novalidate']) }}
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <textarea class="tox-target summernote" id="description4" name="description" rows="8">{!! $job_qualification->description !!}</textarea>
            </div>
        </div>
    </div>
</div>
