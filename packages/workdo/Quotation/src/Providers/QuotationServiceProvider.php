...
use Workdo\Quotation\Providers\EventServiceProvider;
use Workdo\Quotation\Providers\RouteServiceProvider;
...
class QuotationServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->loadViewsFrom(__DIR__ . '/../Resources/views', 'quotation');
