...
@php
    $path = url("packages/workdo/Quotation/src/marketplace");
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="text-center section-title">
                <h2>{{__("Efficient Quotation Management")}}</h2>
                <p>{{__("Managing multiple quotes can be challenging without the right tools. Dash SaaS offers robust quotation management capabilities, allowing you to organize and track quotes effortlessly. You can categorize quotes by account type, customer, or warehouse, making it easy to locate and reference specific quotes as needed.")}}</p>
            </div>
            <div class="row row-gap align-items-center padding-bottom ">
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            <h2>{{__('Simplified Quotation Creation')}}</h2>
                        </div>
                        <p>{{__("Dash SaaS provides a user-friendly interface that makes creating quotations a breeze. You can easily input customer details, select products or services, and set pricing options with just a few clicks. Our intuitive platform eliminates manual calculations and ensures accuracy in every quote. Whether dealing with a single item or complex project pricing, Dash SaaS adapts to your needs, empowering you to generate professional-looking quotes quickly and efficiently.
                            ")}} </p>
                    </div>
                </div>
            ...
            <div class="row row-gap align-items-center padding-bottom ">
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            <h2>{{__('Conversion to Point of Sale (POS)')}}</h2>
                        </div>
                        <p>{{__("Accurately track daily milk yields with Dash SaaS's intuitive recording system. Generate milk production sheets for individual animals or the entire herd effortlessly, enabling you to monitor milk output trends and identify any deviations promptly. By staying informed about milk production levels, you can make informed decisions to maximize efficiency and profitability on your dairy farm.
                            ")}} </p>
                    </div>
                </div>
                <div class="col-lg-7 col-md-6 col-12">
            ...
            <div class="row row-gap align-items-center padding-bottom">
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            <h2>{{__('Enhance Business Efficiency')}}</h2>
                        </div>
                        <p>{{__("By leveraging Dash SaaS for quotation management, businesses can enhance efficiency across the board. With fewer manual tasks and streamlined workflows, you will free up valuable time and resources to focus on core business activities. Moreover, our data-driven insights provide valuable analytics on quoting trends, customer preferences, and sales performance, enabling informed decision-making and continuous improvement. With Dash SaaS, you can elevate your quotation process to new heights and drive business success.")}}</p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="bg-white tabs-wrapper pricing-tab">
                            ...
                            <div class="tabs-container">
                                ...
                                <div class="tab-content" id="tab-2">
                                    <div class="pricing-content">
                                        <div class="price">
                                            <ins><span class="currency-type">{{ super_currency_format_with_sym($module->monthly_price) }}</span> <span class="time-lbl text-muted">{{ __('/Year') }}</span></ins>
                                        </div>
                                        <div class="lbl">{{__('Billed yearly, or')}} <b>{{ super_currency_format_with_sym($module->monthly_price).'/' }}</b>{{__(' if paid yearly')}}</div>
                                        <div class="btn-group">
                                            <a href="{{ route('apps.pricing') }}" class="btn-secondary">{{__('Buy Now')}} <svg
                                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    viewBox="0 0 16 16" fill="none">
        ...
        <div class="container">
            ...
            <div class="screenshot-slider">
                <div class="screenshot-itm">
                    <div class="screenshot-image" target="_blank" class="img-zoom">
                        <img src="{{$path.'/image2.png'}}" alt="">
                    </div>
                </div>
                <div class="screenshot-itm">
                        ...
                        <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 col-12 product-card">
                            <div class="product-card-inner">
                                ...
                                <div class="product-content">
                                    ...
                                    <div class="price">
                                        <ins><span class="currency-type">{{ super_currency_format_with_sym($module->yearly_price) }}</span> <span class="time-lbl text-muted">{{ __('/Month') }}</span></ins>
                                                    <ins><span class="currency-type">{{ super_currency_format_with_sym($module->yearly_price) }}</span> <span class="time-lbl text-muted">{{ __('/Year') }}</span></ins>
                                    </div>
