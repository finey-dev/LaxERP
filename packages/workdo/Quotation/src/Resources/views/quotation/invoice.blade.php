...
@section('page-title')
    {{ __('Quotation To Convert Invoice') }}
@endsection
...
@section('content')
    <div class="row">
        {{ Form::model($quotation, ['route' => ['quotationinvoice.store', $quotation->id], 'method' => 'PUT', 'class' => 'w-100', 'enctype' => 'multipart/form-data']) }}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-6 form-group">
                                            {{ Form::label('quotation', __('Quotation Type'), ['class' => 'form-label']) }}
                                            <select
                                                ...
                                                <option value="invoice" @if ($quotation->quotation == 'invoice') selected @endif>
                                                    {{ __('Invoice') }}</option>
                                                <option value="pos" @if ($quotation->quotation == 'pos') selected @endif>
                                                    {{ __('Pos') }}</option>
                                            </select>
                                        </div>
                                        <div class="form-group col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        {{ Form::select('warehouse_id', $warehouse, null, ['class' => 'form-control select warehouse_id', 'required' => 'required']) }}
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
        ...
        <div class="modal-footer mb-3">
            <input type="button" value="{{ __('Cancel') }}" onclick="location.href = '{{ route('quotation.index') }}';"
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            $("input[name='quotation_type_radio']:checked").trigger('change');
        });
                        ...
                        success: function(data) {
                            ...
                            if (item.taxes == 0) {
                                ...
                                for (var i = 0; i < item.taxes.length; i++) {
                                    taxes +=
                                        '<span class="badge bg-primary p-2 px-3 me-1 product_tax">' +
    ...
    <script>
        ...
        $(document).on('change', "[name='quotation_type_radio']", function() {
            var val = $(this).val();
            $(".quotation_div").empty();
