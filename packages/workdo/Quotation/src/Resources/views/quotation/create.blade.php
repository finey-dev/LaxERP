...
@section('content')
    <div class="row">
        {{ Form::open(['url' => 'quotation', 'class' => 'w-100', 'enctype' => 'multipart/form-data', 'class' => 'needs-validation', 'novalidate']) }}
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            <div class="row" id="customer-box">
                                ...
                                <div class="form-group col-md-6">
                                    {{ Form::label('customer_id', __('Customer/Client'), ['class' => 'form-label']) }}<x-required></x-required>
                                    {{ Form::select('customer_id', $customers, $customerId, ['class' => 'form-control', 'id' => 'customer', 'data-url' => route('proposal.customer'), 'required' => 'required', 'placeholder' => __('Create Customer/Client')]) }}
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select
                                                ...
                                                @if (module_is_active('Account'))
                                                    <option value="product" id="product" class="billing-option">
                                                        {{ __('Item Wise') }}</option>
                                                @endif
                                                @if (module_is_active('Taskly'))
                                                    <option value="project" id="project" class="billing-option">
                                                        {{ __('Project Wise') }}</option>
                                                @endif
                                                @if (module_is_active('CMMS'))
                                                    <option value="parts" id="parts" class="billing-option">
                                ...
                                <div class="col-md-6">
                                    <div
                                        class="form-group quotation_div {{ module_is_active('Account') ? 'd-none' : '' }}">
                                        @if (module_is_active('Taskly'))
    ...
    <script>
        $(document).on('change', ".warehouse", function() {
            ...
            if (val == 'product') {
                ...
                $(".quotation_div").removeClass('d-none');
        ...
        function SectionGet(type = 'product', project_id = "0", title = 'Project', warehouse = "0") {
            $.ajax({
                ...
                data: {
                    ...
                    acction: 'create',
                    warehouse: warehouse // passing warehouse value
                },
                beforeSend: function() {
                    $("#loader").removeClass('d-none');
                },
    ...
    <script>
        $(document).ready(function() {
            $('.account_type').on('change', function() {
                ...
                $('.billing-option').addClass('d-none').hide();
                if (selectedValue == 'Accounting') {
                    $('#product').removeClass('d-none').show();
                } else if (selectedValue == 'Projects') {
                    $('#project').removeClass('d-none').show();
                } else {
                    $('#parts').removeClass('d-none').show();
                }
            });
        });
        ...
        $(document).ready(function() {
            $('.account_type').on('change', function() {
                var type = $(this).val();
                $('.quotation-type').addClass('d-none').hide();
                if (type == 'Accounting') {
