{{ Form::open(array('route' => array('machine.invoice.payment.store', $invoice->id),'method'=>'post','enctype' => 'multipart/form-data')) }}
...
<div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            <div class="form-icon-user">
                {{ Form::number('amount',$invoice->getDue(), array('class' => 'form-control','required'=>'required','step'=>'1','max' => $invoice->getDue())) }}
            </div>
        </div>
