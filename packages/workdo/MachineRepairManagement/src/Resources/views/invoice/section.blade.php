        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                var product_select = `<select class="form-control product_id item js-searchBox" name="${itemSelect}"
                                        placeholder="Select Item" data-url="{{route('machine.invoice.product')}}" required = 'required'>
                                        </select>`;
                ...
                <table class="table  mb-0 table-custom-style" data-repeater-list="items" id="sortable-table">
                    ...
                    <tbody class="ui-sortable" data-repeater-item>
                        <tr>
                            ...
                            <td width="25%" class="form-group pt-0 product_div">
                                    <select name="item" class="form-control product_id item  js-searchBox" data-url="{{route('machine.invoice.product')}}" required>
                    ...
                    <tfoot>
                        ...
                        <tr>
                            ...
                            <td>&nbsp;</td>
                            <td></td>
                            <td><strong>{{ __('Service Charge') }} ({{ isset($company_settings['defult_currancy_symbol']) ? $company_settings['defult_currancy_symbol'] : '' }})</strong>
                            </td>
