{{ Form::model($machine, ['route' => ['machine-repair.update', $machine->id], 'id' => 'machine', 'method' => 'PUT', 'enctype' => 'multipart/form-data','class'=>'needs-validation','novalidate']) }}
