...
@php
    $path = url('packages/workdo/FileSharing/src/marketplace');
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
                ...
                <div class="row row-gap align-items-center pdp-summery-row">
                    <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                        <div class="pdp-summery">
                            ...
                            <p>{{ __('In a general sense, a "FileSharing" module could refer to a component or feature within a software application or system that facilitates the sharing of files between users or devices.') }}
                            </p>
                            <div class="price">
                                <ins><span
        ...
        <section class="dedicated-themes-section padding-bottom">
            <div class="container">
                <div class="section-title text-center">
                    <h2>{{ __('FileSharing ') }}<b>{{ __(' Management ') }}</b></h2>
                    <p>{{ __('File sharing management refers to the process of monitoring and controlling the sharing of digital files between users or within an organisation. A file sharing management system helps to streamline collaboration, you will also get various options like password security, types like email and link.') }}
                    </p>
                </div>
                    ...
                    <div class="col-lg-5 col-md-6 col-12">
                        <div class="abt-theme">
                            <div class="section-title">
                                ...
                                <h2>{{ __('What is the purpose of the FileSharing feature?') }}</h2>
                            </div>
                            <p>{{ __('The purpose of the file sharing feature is to facilitate the exchange and distribution of digital files between users or groups of users. It enables seamless collaboration, efficient communication and easy access to shared content. In it you can also select multiple users, add image, pdf, txt files etc and you can also share files through mail or link.') }}
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-5 col-md-6 col-12">
                        <div class="abt-theme">
                            <div class="section-title">
                                ...
                                <h2>{{ __('File activity management') }}</h2>
                            </div>
                            <p>{{ __('In file activity management, you can know and view file name, IP address, date, country, device, OS etc. when a file is downloaded.') }}
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-5 col-md-6 col-12">
                        <div class="abt-theme">
                            <div class="section-title">
                                ...
                                <h2>{{ __('Trash: Recover and Manage Deleted Files') }}</h2>
                            </div>
                            <p>{{ __('The Trash feature acts as a safeguard against accidental file deletions. When a user deletes a file, it is moved to the Trash folder instead of being permanently removed. This allows for easy recovery of mistakenly deleted files, reducing the risk of data loss. Files in the Trash can be reviewed, restored, or permanently deleted, giving users control over their data and maintaining operational efficiency.') }}
                            </p>
                        </div>
                    </div>
                </div>
