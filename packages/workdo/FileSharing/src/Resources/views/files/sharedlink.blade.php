...
<head>
    ...
    <meta name="description"
        content="{{ isset($admin_settings['meta_description']) ? $admin_settings['meta_description'] : 'Discover the efficiency of Dash, a user-friendly web application by WorkDo.' }}">
    ...
    <link rel="stylesheet"
        href="{{ asset('packages/workdo/FileSharing/src/Resources/assets/css/filesharecustom.css') }}">
...
<body class="download-page-bg {{ isset($company_settings['color']) ? $company_settings['color'] : 'theme-1' }}">
    <div class="download-bg-img">
        <img src="{{ asset('packages/workdo/FileSharing/src/Resources/assets/img/d2.svg') }}"
            class="bg-img-2-1 bg-img-5">
        <img src="{{ asset('packages/workdo/FileSharing/src/Resources/assets/img/d3.svg') }}"
            class="bg-img-2-1 bg-img-6">
        <img src="{{ asset('packages/workdo/FileSharing/src/Resources/assets/img/d4.svg') }}"
            class="bg-img-2-1 bg-img-7">
        <img src="{{ asset('packages/workdo/FileSharing/src/Resources/assets/img/d5.svg') }}"
            class="bg-img-2-1 bg-img-8">
        <img src="{{ asset('packages/workdo/FileSharing/src/Resources/assets/img/d6.png') }}"
            class="bg-img-2-1 bg-img-9">
    </div>
            ...
            <div class="row align-items-center">
                <div class="col-xl-5 col-md-6">
                    <div class="download-content text-center">
                        <h2 class="text-center">{{ __('Your Download') }} <br>{{ __('is ready') }}</h2>
                ...
                <div class="col-xl-7 col-md-6">
                    <div class="download-img">
                        <img src="{{ asset('packages/workdo/FileSharing/src/Resources/assets/img/4.png') }}">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="footer-wrapper">
            <div class="py-1">
                <span class="text-muted">
                    ...
                    @else
                        {{ __('Copyright') }} &copy; {{ config('app.name', 'Workdo Dash') }}
                    @endif{{ date('Y') }}
                </span>
            </div>
        </div>
