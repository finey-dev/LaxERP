{{ Form::model($file, ['route' => ['files.update', $file->id], 'method' => 'PUT', 'enctype' => 'multipart/form-data', 'class'=>'needs-validation','novalidate']) }}
    ...
    <div class="row">
        <div class="col-12 field" data-name="attachment">
            <div class="form-group">
                ...
                <img id="blah" class="mt-2" src="{{ check_file($file->file_path) ? get_file($file->file_path) : 'packages/workdo/FileSharing/src/Resources/assets/img/gallery.png' }}"
                        width="20%" height="20%" />
            </div>
        </div>
        <div class="col-md-12">
            <div class="form-group">
                ...
                <div class="col-md-12 email">
                    ...
                    {{ Form::email('email', null, ['class' => 'form-control', 'min' => '0', 'placeholder' => __('Enter Email')]) }}
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12 ps_div d-none mb-2">
            <div class="form-group">
        ...
        <div class="col-12 form-group">
            {{ Form::label('users_list', __('Users'), ['class' => 'form-label']) }}<x-required></x-required>
            {{ Form::select('users_list[]', $users, explode(',', $file->user_id), ['class' => 'form-control choices', 'id' => 'choices-multiple1', 'multiple' => '','required' => 'required']) }}
        </div>
        <div class="col-12">
            <div class="form-group">
                {{ Form::label('description', __('Description'), ['class' => 'form-label']) }}<x-required></x-required>
                {{ Form::textarea('description', null, ['class' => 'form-control', 'rows' => 3, 'placeholder' => __('Enter Description'), 'required' => 'required']) }}
            </div>
        </div>
    </div>
</div>
