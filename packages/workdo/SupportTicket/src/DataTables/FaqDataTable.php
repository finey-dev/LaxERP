...
class FaqDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query)
    {
        ...
        ->editColumn('description', function (Faq $faq) {
            $description = strip_tags($faq->description);
        ...
        if (
            \Laratrust::hasPermission('faq edit') ||
            \Laratrust::hasPermission('faq delete')
        ) {
            $dataTable->addColumn('action', function (Faq $faq) {

                return view('support-ticket::faq.action', compact('faq'));
            });
            $rawColumn[] = 'action';
        }
    ...
    {
        $faqs =  $model->where('created_by', creatorId())->where('workspace_id', getActiveWorkSpace());
