...
@php
    $path = url('packages/workdo/SupportTicket/src/marketplace');
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
            ...
            <div class="row row-gap align-items-center pdp-summery-row">
                <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                    <div class="pdp-summery">
                        ...
                        <p>{{__('Your clients are happier and more likely to trust you if you answer their queries fast. Support Ticket makes it super easy for your clients to create tickets, and allows you to resolve them quickly and easily.')}}</p>
                        <div class="price">
                            <ins><span
                                    class="currency-type">{{ super_currency_format_with_sym($module->monthly_price) }}</span>
                                <span class="time-lbl text-muted">{{ __('/Month') }}</span></ins>
                            <ins><span
                                    class="currency-type">{{ super_currency_format_with_sym($module->yearly_price) }}</span>
                                <span class="time-lbl text-muted">{{ __('/Year') }}</span></ins>
                        </div>
    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="section-title text-center">
                <h2>{{__('The smartest way to manage your customer support tickets')}}</h2>
                <p>{{__('Support Ticket is the ONLY ticket management tool that makes it easy for you to manage support tickets smoothly. You and your team can access your clients’ tickets, respond to them, and resolve them - in a few clicks.')}}</p>
            </div>
            <div class="row row-gap padding-bottom ">
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            <h2>{{__('Improve your customer service experience')}}</h2>
                        </div>
                        <p>{{__('Keep track of all your tickets and agents with ease. support ticket centralized dashboard puts all clients tickets, as well as all your agents in one place. This way, it’ll be easy to ensure that queries are being addressed at the right time.')}} </p>
                        <div class="theme-acnav">
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Create a fast and simple ticket system for your clients')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Make it super easy for your clients to create tickets. With TicketGo SaaS, your clients can open tickets in seconds. They also receive instant responses from your agents - so they can rest, assured that help is on the way.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Manage all customer support tickets from a central dashboard.')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Attend to your customers’ queries in record time, and gain their trust. With TicketGo SaaS, multiple admins from your team can access and manage tickets.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Create a quick and easy ticket generation process')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Support Ticket makes creating tickets fun and simple for your clients. Your clients can select their query from a list of FAQs, fill the simplified form, attach files, submit, and receive a unique ticket ID - In a matter of seconds!')}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row row-gap  padding-bottom">
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            <h2>{{__('Organize & Manage Your Support Ticket System')}}</h2>
                        </div>
                        <p>{{__('Get easy access to open and closed ticket statistics. A visual presentation of categories and a monthly generated ticket chart are presented.')}}</p>
                        <div class="theme-acnav">
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    <span class="acnav-icon">
                                    ...
                                    <span>{{__('Organize, manage, and control all support tickets')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Manage and control your entire support ticket system without lifting a finger. Create ticket categories, organize tickets, respond to them, and edit their status. Add multiple admins and agents, assign customer requests to them - and do so much more!')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Keep track of everything in one place')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('View all your tickets and agents at a glance. Access the statistics of all your tickets and agents. View a monthly support ticket chart, get a graphical presentation of all ticket categories, and more! - in just one dashboard.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Knowledge Base Module')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('The Frequently Asked Questions are always convenient no matter what. What about the feature which adds more benefit to that?
                                        Here, this Knowledge Base Module is helping you with the same. You can update the “Knowledgebase Category” according to your requirements and familiarity, and you can give a thorough description under the particular title.')}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row row-gap align-items-center padding-bottom">
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            <h2>{{__('Communicate with your customers seamlessly')}}</h2>
                        </div>
                        <p>{{__('The custom ticket form has made the process of questioning easy and reliable. Once you submit the ticket, a unique link has been generated for you for further communication which makes the whole process smooth.')}}</p>
                    </div>
                </div>
                <div class="col-lg-7 col-md-6 col-12">
                    <div class="dash-theme-preview">
            ...
            <div class="row row-gap align-items-center ">
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            <h2>{{__('Make it easy for clients to follow up on their tickets')}}</h2>
                        </div>
                        <p> {{__('Add new tickets as and when required. Get a detailed list of all the generated tickets with their respective ticket IDs, categories, subject, status, and essential information. Edit them by adding a new response or changing the status with a simple click.')}}</p>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="tabs-container">
                                <div class="tab-content active" id="tab-1">
                                    <div class="pricing-content">
                                        ...
                                        <div class="lbl">{{ __('Billed monthly, or') }}
                                            <b>{{ super_currency_format_with_sym($module->monthly_price) . '/' }}</b>{{ __(' if paid monthly') }}
                                        </div>
                                        <div class="btn-group">
                                ...
                                <div class="tab-content" id="tab-2">
                                    <div class="pricing-content">
                                        ...
                                        <div class="lbl">{{ __('Billed yearly, or') }}
                                            <b>{{ super_currency_format_with_sym($module->yearly_price) . '/' }}</b>{{ __(' if paid yearly') }}
                                        </div>
                                        <div class="btn-group">
                                            <a href="{{ route('apps.pricing') }}" class="btn-secondary">{{__('Buy Now')}}<svg
                                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                            ...
                            <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 col-12 product-card">
                                <div class="product-card-inner">
                                    ...
                                    <div class="product-content">
                                        <h4> <a href="product.html">{{ $module->alias }}</a>
                                        </h4>
                                        <div class="price">
                                            <ins><span
                                                    class="currency-type">{{ super_currency_format_with_sym($module->monthly_price) }}</span>
                                        ...
                                        <a href="{{ route('software.details', $module->alias) }}"
                                            target="_new" class="btn cart-btn">View Details</a>
                                    </div>
                                </div>
                            </div>
                        @endif
