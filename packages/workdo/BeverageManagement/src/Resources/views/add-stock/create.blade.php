{{ Form::open(['route' => 'add-stock.store', 'class'=>'needs-validation','novalidate']) }}
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            {!! Form::select('to_collection_center', ['' => 'Select Collection Center '], null, ['class' => 'form-control', 'id' => 'to_collection_center','required'=> 'required']) !!}
        </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#item_id').on('change', function() {
            ...
            $.ajax({
                url: "{{ route('item.collection.center') }}",
                type: "POST",
                data: {
                    item_id: item_id,
                    _token: '{{ csrf_token() }}'
