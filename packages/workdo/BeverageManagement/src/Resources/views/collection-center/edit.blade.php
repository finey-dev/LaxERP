{{ Form::model($collection_center, array('route' => array('collection-center.update', $collection_center->id), 'method' => 'PUT','class'=>'needs-validation','novalidate')) }}
<div class="modal-body">
    <div class="row">
        <div class="col-md-12">
            <div class="form-group col-md-12">
                {{ Form::label('location_name', __('Location Name'), ['class' => 'form-label']) }}<x-required></x-required>
                {{ Form::text('location_name', null,['class' => 'form-control', 'required' => 'required','placeholder'=>'Enter Location Name']) }}
            </div>
            <div class="form-group col-md-12">
