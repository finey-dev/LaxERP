{{ Form::open(['route' => 'quality-checks.store','class'=>'needs-validation','novalidate']) }}
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            {{ Form::date('check_date', '', ['class' => 'form-control', 'required' => 'required']) }}
        </div>
        <div class="form-group col-md-6">
            {{ Form::label('check_type', __('Check Type'), ['class' => 'form-label']) }}<x-required></x-required>
            {{ Form::text('check_type', '', ['class' => 'form-control', 'required' => 'required','placeholder'=>'Enter Check Type']) }}
        </div>
        <div class="form-group col-md-6">
            {{ Form::label('result', __('Result'), ['class' => 'form-label']) }}<x-required></x-required>
            {{ Form::text('result', '', ['class' => 'form-control', 'required' => 'required','placeholder'=>'Enter Result']) }}
        </div>
