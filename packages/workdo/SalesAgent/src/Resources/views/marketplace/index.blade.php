...
@php
    $path = url("packages/workdo/SalesAgent/src/marketplace");
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
            ...
            <div class="row row-gap align-items-center pdp-summery-row">
                <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                    <div class="pdp-summery">
                        ...
                        <p>{{__('Utilize a comprehensive Sales Agent Add-on to enhance your sales team\'s management of sales activities, customer relationships, and achieve performance goals')}}</p>
                        <div class="price">
    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="section-title text-center">
                <h2>{{__('Boost Sales Efficiency')}}</h2>
                <p>{{__('Elevate your sales operations with the SalesAgent Module, a one-stop solution for efficient program management, sales agent performance tracking, and order-to-invoice processes.')}}</p>
            </div>
            <div class="row row-gap padding-bottom ">
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            <div class="subtitle">
                                <h2>{{__('Program Management')}}</h2>
                            </div>
                            <p>{{__('Take control of your sales programs effortlessly. Create, assign, and monitor programs to drive revenue and enhance collaboration.')}} </p>
                        </div>
                        ...
                        <div class="theme-acnav">
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Create Custom Programs')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Tailor programs to your unique needs and objectives, ensuring that they align with your strategic vision.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Real-time Progress Tracking')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Stay in the loop with real-time tracking of program progress, empowering you to make timely adjustments.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Streamlined Assignment and Notifications')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Collaborate effectively with your sales team by easily assigning programs and sending notifications for updates and deadlines.')}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row row-gap  padding-bottom">
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            <div class="subtitle">
                                <h2>{{__('Sales Agent Dashboard')}}</h2>
                            </div>
                            <p>{{__('Empower your sales agents with a dedicated, insightful dashboard. Provide them with the tools and insights they need to excel in their roles and contribute to your company\'s success.')}}</p>
                        </div>
                        ...
                        <div class="theme-acnav">
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Track Sales Performance and KPIs')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Stay on top of key performance indicators and sales performance data, enabling data-driven decision-making.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('View Program Details and Progress')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Keep tabs on program-related data, including details and progress, making it easier to manage initiatives effectively.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Manage Orders and Invoices Seamlessly')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Simplify the order-to-invoice processes, making it effortless to manage sales transactions, invoices, and payments.')}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row row-gap align-items-center padding-bottom">
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            <div class="subtitle">
                                <h2>{{__('Purchase Orders and Invoices')}}</h2>
                            </div>
                        </div>
                        <p>{{__('Streamline order creation, generate invoices with ease, and maintain control over your financial transactions. Simplify the entire process from order initiation to invoicing.')}}</p>
