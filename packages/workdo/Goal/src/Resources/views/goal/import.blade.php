...
<div class="modal-body">
    <div class="row">
        <div class="col-md-12 mb-6">
            {{ Form::label('file', __('Download Sample Goal CSV File'), ['class' => 'form-label text-danger mx-1']) }}
            @if (check_file('uploads/sample/sample_goal.csv'))
                <a href="{{ asset('uploads/sample/sample_goal.csv') }}" class="btn btn-sm btn-primary btn-icon-only">
...
<div class="modal-footer">
    ...
    <a href="" data-url="{{ route('goal.import.modal') }}" data-ajax-popup-over="true"
        title="{{ __('Create') }}" data-size="xl" data-title="{{ __('Import Goal CSV Data') }}"
