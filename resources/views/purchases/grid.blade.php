                        ...
                        <div class="project-card-inner">
                            <div class="project-card-header d-flex justify-content-between">
                                ...
                                @elseif($purchase->status == 2)
                                    <span class="purchase_status badge bg-danger p-2 px-3">{{ __(App\Models\Purchase::$statues[$purchase->status]) }}</span>
                            ...
                            <div class="project-card-content">
                                ...
                                <div
                                    ...
                                    <div class="comment d-flex align-items-center gap-2">
                                        @permission('purchase show')
                                            <a class="btn btn-sm btn-warning" href="{{ route('purchases.show',\Crypt::encrypt($purchase->id)) }}" data-size="md"class="dropdown-item" data-bs-toggle="tooltip"  title="{{__('Show')}}">
