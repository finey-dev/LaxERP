                                    ...
                                    <td>
                                        @if (!empty($payment->add_receipt) && empty($payment->receipt) && check_file($payment->add_receipt))
                                            <a href="{{ check_file($payment->add_receipt) ? get_file($payment->add_receipt) : '-' }}"
                                                download="" class="btn btn-sm btn-primary btn-icon p-2 me-1" target="_blank"><span class="btn-inner--icon">
                                                    <i class="ti ti-download"></i></span></a>
                                            <a href="{{ check_file($payment->add_receipt) ? get_file($payment->add_receipt) : '-' }}"
                                                class="btn btn-sm btn-secondary btn-icon p-2 me-1" target="_blank"><span class="btn-inner--icon">
                                                    <i class="ti ti-crosshair"></i></span></a>
